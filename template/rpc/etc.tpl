...
Mysql:
  DataSource: root:123456@tcp(127.0.0.1:3307)/kube_nova?charset=utf8mb4&parseTime=True&loc=Local&timeout=10s
  MaxOpenConns: 100
  MaxIdleConns: 10
  ConnMaxLifetime: 30m
...
DevServer:
  Enabled: true
  Port: 9999              # 默认 6060
  HealthPath: "/healthz"  # 默认 /healthz
  MetricsPath: "/metrics" # 默认 /metrics
