...
// 删除仓库
func DeleteRepositoryHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := registry.NewDeleteRepositoryLogic(r.Context(), svcCtx)
		resp, err := l.DeleteRepository(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
