...
// 手动触发GC
func TriggerGCHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TriggerGCRequest
		...
		l := registry.NewTriggerGCLogic(r.Context(), svcCtx)
		resp, err := l.TriggerGC(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
