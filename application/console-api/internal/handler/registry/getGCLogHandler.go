...
// 获取GC日志
func GetGCLogHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetGCLogRequest
		...
		l := registry.NewGetGCLogLogic(r.Context(), svcCtx)
		resp, err := l.GetGCLog(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
