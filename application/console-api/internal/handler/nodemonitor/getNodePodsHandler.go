...
// 获取节点上的 Pod 信息
func GetNodePodsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodePodsRequest
		...
		l := nodemonitor.NewGetNodePodsLogic(r.Context(), svcCtx)
		resp, err := l.GetNodePods(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
