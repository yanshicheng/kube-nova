...
// 获取节点内存指标
func GetNodeMemoryHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodeMemoryRequest
		...
		l := nodemonitor.NewGetNodeMemoryLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeMemory(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
