...
// 获取节点网络指标
func GetNodeNetworkHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodeNetworkRequest
		...
		l := nodemonitor.NewGetNodeNetworkLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeNetwork(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
