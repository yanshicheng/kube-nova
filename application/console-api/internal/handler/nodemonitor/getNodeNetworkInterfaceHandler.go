...
// 获取节点指定网络接口指标
func GetNodeNetworkInterfaceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodeNetworkInterfaceRequest
		...
		l := nodemonitor.NewGetNodeNetworkInterfaceLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeNetworkInterface(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
