...
// 获取节点状况
func GetNodeConditionsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodeConditionsRequest
		...
		l := nodemonitor.NewGetNodeConditionsLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeConditions(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
