...
// 获取节点磁盘指标
func GetNodeDiskHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodeDiskRequest
		...
		l := nodemonitor.NewGetNodeDiskLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeDisk(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
