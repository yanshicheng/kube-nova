...
// 获取节点已分配资源
func GetNodeAllocatedHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodeAllocatedRequest
		...
		l := nodemonitor.NewGetNodeAllocatedLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeAllocated(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
