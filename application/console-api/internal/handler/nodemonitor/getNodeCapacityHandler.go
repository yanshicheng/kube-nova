...
// 获取节点容量
func GetNodeCapacityHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodeCapacityRequest
		...
		l := nodemonitor.NewGetNodeCapacityLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeCapacity(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
