...
// 获取节点网络接口列表
func GetNodeNetworkInterfacesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodeNetworkInterfacesRequest
		...
		l := nodemonitor.NewGetNodeNetworkInterfacesLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeNetworkInterfaces(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
