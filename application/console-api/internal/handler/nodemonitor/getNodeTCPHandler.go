...
// 获取节点 TCP 指标
func GetNodeTCPHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodeTCPRequest
		...
		l := nodemonitor.NewGetNodeTCPLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeTCP(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
