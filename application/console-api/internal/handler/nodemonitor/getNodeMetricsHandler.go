...
// 获取节点综合指标
func GetNodeMetricsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodeMetricsRequest
		...
		l := nodemonitor.NewGetNodeMetricsLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeMetrics(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
