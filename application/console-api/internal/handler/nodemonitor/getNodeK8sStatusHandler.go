...
// 获取节点 K8s 状态
func GetNodeK8sStatusHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodeK8sStatusRequest
		...
		l := nodemonitor.NewGetNodeK8sStatusLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeK8sStatus(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
