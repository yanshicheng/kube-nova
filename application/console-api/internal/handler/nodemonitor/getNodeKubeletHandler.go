...
// 获取节点 Kubelet 指标
func GetNodeKubeletHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodeKubeletRequest
		...
		l := nodemonitor.NewGetNodeKubeletLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeKubelet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
