...
// 对比多个节点
func CompareNodesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CompareNodesRequest
		...
		l := nodemonitor.NewCompareNodesLogic(r.Context(), svcCtx)
		resp, err := l.CompareNodes(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
