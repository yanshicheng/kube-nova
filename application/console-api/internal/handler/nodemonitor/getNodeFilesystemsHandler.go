...
// 获取节点文件系统列表
func GetNodeFilesystemsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodeFilesystemsRequest
		...
		l := nodemonitor.NewGetNodeFilesystemsLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeFilesystems(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
