...
// 获取节点系统指标
func GetNodeSystemHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodeSystemRequest
		...
		l := nodemonitor.NewGetNodeSystemLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeSystem(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
