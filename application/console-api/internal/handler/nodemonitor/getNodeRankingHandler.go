...
// 获取节点排行
func GetNodeRankingHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodeRankingRequest
		...
		l := nodemonitor.NewGetNodeRankingLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeRanking(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
