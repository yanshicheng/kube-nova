...
// 获取节点磁盘设备列表
func GetNodeDiskDevicesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetNodeDiskDevicesRequest
		...
		l := nodemonitor.NewGetNodeDiskDevicesLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeDiskDevices(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
