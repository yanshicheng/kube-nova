...
func ListIngressMetricsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListIngressMetricsRequest
		...
		l := ingressmonitor.NewListIngressMetricsLogic(r.Context(), svcCtx)
		resp, err := l.ListIngressMetrics(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
