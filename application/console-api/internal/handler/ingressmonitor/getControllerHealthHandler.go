...
func GetControllerHealthHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetControllerHealthRequest
		...
		l := ingressmonitor.NewGetControllerHealthLogic(r.Context(), svcCtx)
		resp, err := l.GetControllerHealth(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
