...
// 删除文件或目录
func PodFileDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileDeleteReq
		...
		l := pod.NewPodFileDeleteLogic(r.Context(), svcCtx)
		resp, err := l.PodFileDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
