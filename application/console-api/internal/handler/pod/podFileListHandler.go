...
// 列出文件和目录
func PodFileListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileListReq
		...
		l := pod.NewPodFileListLogic(r.Context(), svcCtx)
		resp, err := l.PodFileList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
