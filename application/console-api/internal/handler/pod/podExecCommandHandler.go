...
// 非交互式执行命令
func PodExecCommandHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodExecCommandReq
		...
		l := pod.NewPodExecCommandLogic(r.Context(), svcCtx)
		resp, err := l.PodExecCommand(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
