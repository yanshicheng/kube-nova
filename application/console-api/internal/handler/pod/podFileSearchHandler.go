...
// 搜索文件
func PodFileSearchHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileSearchReq
		...
		l := pod.NewPodFileSearchLogic(r.Context(), svcCtx)
		resp, err := l.PodFileSearch(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
