...
// 获取文件详细信息
func PodFileInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileInfoReq
		...
		l := pod.NewPodFileInfoLogic(r.Context(), svcCtx)
		resp, err := l.PodFileInfo(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
