...
// 检查文件权限
func PodFileCheckPermissionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileCheckPermissionReq
		...
		l := pod.NewPodFileCheckPermissionLogic(r.Context(), svcCtx)
		resp, err := l.PodFileCheckPermission(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
