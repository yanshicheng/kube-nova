...
// 初始化分块上传
func PodFileUploadInitHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileUploadInitReq
		...
		l := pod.NewPodFileUploadInitLogic(r.Context(), svcCtx)
		resp, err := l.PodFileUploadInit(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
