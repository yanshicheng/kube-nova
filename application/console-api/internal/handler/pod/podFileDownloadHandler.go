...
// 下载文件
func PodFileDownloadHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		// 1. 解析参数
		var req types.PodFileDownloadReq
		...
		l := pod.NewPodFileDownloadLogic(r.Context(), svcCtx, w, r)
		if err := l.PodFileDownload(&req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		}
