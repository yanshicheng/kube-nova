...
// 移动或重命名文件
func PodFileMoveHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileMoveReq
		...
		l := pod.NewPodFileMoveLogic(r.Context(), svcCtx)
		resp, err := l.PodFileMove(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
