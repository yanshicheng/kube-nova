...
// 保存文件内容
func PodFileSaveHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileSaveReq
		...
		l := pod.NewPodFileSaveLogic(r.Context(), svcCtx)
		resp, err := l.PodFileSave(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
