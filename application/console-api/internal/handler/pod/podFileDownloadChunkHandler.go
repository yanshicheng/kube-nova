...
// 分块下载文件
func PodFileDownloadChunkHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileDownloadChunkReq
		...
		l := pod.NewPodFileDownloadChunkLogic(r.Context(), svcCtx)
		resp, err := l.PodFileDownloadChunk(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
