...
// 压缩文件或目录
func PodFileCompressHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileCompressReq
		...
		l := pod.NewPodFileCompressLogic(r.Context(), svcCtx)
		resp, err := l.PodFileCompress(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
