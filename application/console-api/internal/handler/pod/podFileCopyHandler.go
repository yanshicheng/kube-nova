...
// 复制文件或目录
func PodFileCopyHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileCopyReq
		...
		l := pod.NewPodFileCopyLogic(r.Context(), svcCtx)
		resp, err := l.PodFileCopy(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
