...
// 取消上传
func PodFileUploadCancelHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileUploadCancelReq
		...
		l := pod.NewPodFileUploadCancelLogic(r.Context(), svcCtx)
		resp, err := l.PodFileUploadCancel(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
