...
// 上传文件块
func PodFileUploadChunkHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileUploadChunkReq
		...
		l := pod.NewPodFileUploadChunkLogic(r.Context(), svcCtx)
		resp, err := l.PodFileUploadChunk(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
