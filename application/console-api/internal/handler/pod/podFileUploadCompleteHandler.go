...
// 完成分块上传
func PodFileUploadCompleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileUploadCompleteReq
		...
		l := pod.NewPodFileUploadCompleteLogic(r.Context(), svcCtx)
		resp, err := l.PodFileUploadComplete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
