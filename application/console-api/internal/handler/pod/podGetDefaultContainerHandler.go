...
// 获取 Pod 默认容器
func PodGetDefaultContainerHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodGetDefaultContainerReq
		...
		l := pod.NewPodGetDefaultContainerLogic(r.Context(), svcCtx)
		resp, err := l.PodGetDefaultContainer(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
