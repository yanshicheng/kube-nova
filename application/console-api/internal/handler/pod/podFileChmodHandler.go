...
// 修改文件权限
func PodFileChmodHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileChmodReq
		...
		l := pod.NewPodFileChmodLogic(r.Context(), svcCtx)
		resp, err := l.PodFileChmod(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
