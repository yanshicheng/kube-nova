...
// 获取文件统计信息
func PodFileStatsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileStatsReq
		...
		l := pod.NewPodFileStatsLogic(r.Context(), svcCtx)
		resp, err := l.PodFileStats(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
