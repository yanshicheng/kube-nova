...
// 查询上传状态
func PodFileUploadStatusHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileUploadStatusReq
		...
		l := pod.NewPodFileUploadStatusLogic(r.Context(), svcCtx)
		resp, err := l.PodFileUploadStatus(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
