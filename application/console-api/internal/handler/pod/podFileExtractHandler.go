...
// 解压文件
func PodFileExtractHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodFileExtractReq
		...
		l := pod.NewPodFileExtractLogic(r.Context(), svcCtx)
		resp, err := l.PodFileExtract(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
