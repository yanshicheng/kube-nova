...
// Exec 会话心跳检查
func PodExecPingHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodExecPingReq
		...
		l := pod.NewPodExecPingLogic(r.Context(), svcCtx)
		resp, err := l.PodExecPing(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
