...
// 获取 Pod 日志（一次性，不跟踪）
func PodLogsGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PodLogsGetReq
		...
		l := pod.NewPodLogsGetLogic(r.Context(), svcCtx)
		resp, err := l.PodLogsGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
