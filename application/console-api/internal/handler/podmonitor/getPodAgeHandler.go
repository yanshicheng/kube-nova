...
// 获取 Pod 年龄
func GetPodAgeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetPodAgeRequest
		...
		l := podmonitor.NewGetPodAgeLogic(r.Context(), svcCtx)
		resp, err := l.GetPodAge(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
