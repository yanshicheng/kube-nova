...
func ListCanariesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListCanariesRequest
		...
		l := flaggermonitor.NewListCanariesLogic(r.Context(), svcCtx)
		resp, err := l.ListCanaries(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
