...
func GetNodeDetailYamlHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := node.NewGetNodeDetailYamlLogic(r.Context(), svcCtx)
		resp, err := l.GetNodeDetailYaml(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
