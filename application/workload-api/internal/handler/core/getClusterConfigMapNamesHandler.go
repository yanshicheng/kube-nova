...
func GetClusterConfigMapNamesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := core.NewGetClusterConfigMapNamesLogic(r.Context(), svcCtx)
		resp, err := l.GetClusterConfigMapNames(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
