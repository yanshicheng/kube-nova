...
// 获取 RoleBinding 详细描述
func RoleBindingDescribeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := core.NewRoleBindingDescribeLogic(r.Context(), svcCtx)
		resp, err := l.RoleBindingDescribe(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
