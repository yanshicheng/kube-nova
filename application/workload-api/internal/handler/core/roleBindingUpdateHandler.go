...
// 更新 RoleBinding
func RoleBindingUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := core.NewRoleBindingUpdateLogic(r.Context(), svcCtx)
		resp, err := l.RoleBindingUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
