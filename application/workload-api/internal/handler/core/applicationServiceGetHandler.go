...
// 服务级 service 获取
func ApplicationServiceGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetAppServicesRequest
		...
		l := core.NewApplicationServiceGetLogic(r.Context(), svcCtx)
		resp, err := l.ApplicationServiceGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
