...
// 获取资源关联的 Service 列表
func ServicesGetResourceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := core.NewServicesGetResourceLogic(r.Context(), svcCtx)
		resp, err := l.ServicesGetResource(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
