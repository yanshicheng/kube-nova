...
// 获取 RoleBinding 关联信息
func RoleBindingGetAssociationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := core.NewRoleBindingGetAssociationLogic(r.Context(), svcCtx)
		resp, err := l.RoleBindingGetAssociation(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
