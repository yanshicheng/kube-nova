...
// 删除 RoleBinding
func RoleBindingDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := core.NewRoleBindingDeleteLogic(r.Context(), svcCtx)
		resp, err := l.RoleBindingDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
