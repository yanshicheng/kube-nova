...
// 获取 PVC 关联信息
func PVCGetAssociationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := core.NewPVCGetAssociationLogic(r.Context(), svcCtx)
		resp, err := l.PVCGetAssociation(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
