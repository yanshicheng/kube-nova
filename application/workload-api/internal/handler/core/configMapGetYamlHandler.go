...
// 获取 ConfigMap YAML
func ConfigMapGetYamlHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := core.NewConfigMapGetYamlLogic(r.Context(), svcCtx)
		resp, err := l.ConfigMapGetYaml(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
