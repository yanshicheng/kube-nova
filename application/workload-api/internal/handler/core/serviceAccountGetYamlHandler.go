...
func ServiceAccountGetYamlHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := core.NewServiceAccountGetYamlLogic(r.Context(), svcCtx)
		resp, err := l.ServiceAccountGetYaml(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
