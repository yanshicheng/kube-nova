...
// 更新 ServiceAccount
func ServiceAccountUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ClusterNamespaceResourceUpdateRequest
		...
		l := core.NewServiceAccountUpdateLogic(r.Context(), svcCtx)
		resp, err := l.ServiceAccountUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
