...
func ServiceAccountListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ClusterNamespaceRequest
		...
		l := core.NewServiceAccountListLogic(r.Context(), svcCtx)
		resp, err := l.ServiceAccountList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
