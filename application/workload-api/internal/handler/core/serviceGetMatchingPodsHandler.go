...
func ServiceGetMatchingPodsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DefaultNameRequest
		...
		l := core.NewServiceGetMatchingPodsLogic(r.Context(), svcCtx)
		resp, err := l.ServiceGetMatchingPods(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
