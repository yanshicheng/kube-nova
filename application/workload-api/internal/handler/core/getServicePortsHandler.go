...
// 获取 service 端口
func GetServicePortsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ServicePortsRequest
		...
		l := core.NewGetServicePortsLogic(r.Context(), svcCtx)
		resp, err := l.GetServicePorts(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
