...
// 创建 ConfigMap
func CreateConfigMapHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ConfigMapRequest
		...
		l := core.NewCreateConfigMapLogic(r.Context(), svcCtx)
		resp, err := l.CreateConfigMap(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
