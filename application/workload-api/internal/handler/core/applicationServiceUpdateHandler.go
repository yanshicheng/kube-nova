...
// 服务级 service 更新
func ApplicationServiceUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ApplicationServiceRequest
		...
		l := core.NewApplicationServiceUpdateLogic(r.Context(), svcCtx)
		resp, err := l.ApplicationServiceUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
