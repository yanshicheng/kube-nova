...
// 获取 ConfigMap 引用情况
func ConfigMapGetUsageHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := core.NewConfigMapGetUsageLogic(r.Context(), svcCtx)
		resp, err := l.ConfigMapGetUsage(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
