...
func ServiceAccountGetAssociationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ClusterNamespaceResourceRequest
		...
		l := core.NewServiceAccountGetAssociationLogic(r.Context(), svcCtx)
		resp, err := l.ServiceAccountGetAssociation(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
