...
// 服务级 service 创建
func ApplicationServiceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := core.NewApplicationServiceLogic(r.Context(), svcCtx)
		resp, err := l.ApplicationService(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
