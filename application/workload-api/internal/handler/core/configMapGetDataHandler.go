...
func ConfigMapGetDataHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := core.NewConfigMapGetDataLogic(r.Context(), svcCtx)
		resp, err := l.ConfigMapGetData(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
