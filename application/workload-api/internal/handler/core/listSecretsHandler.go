...
// 获取 Secret 列表
func ListSecretsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SecretListRequest
		...
		l := core.NewListSecretsLogic(r.Context(), svcCtx)
		resp, err := l.ListSecrets(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
