...
// 获取 Role 关联信息
func RoleGetAssociationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := core.NewRoleGetAssociationLogic(r.Context(), svcCtx)
		resp, err := l.RoleGetAssociation(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
