...
// 获取 RoleBinding YAML
func RoleBindingGetYamlHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := core.NewRoleBindingGetYamlLogic(r.Context(), svcCtx)
		resp, err := l.RoleBindingGetYaml(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
