...
func ServiceAccountDescribeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := core.NewServiceAccountDescribeLogic(r.Context(), svcCtx)
		resp, err := l.ServiceAccountDescribe(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
