...
func ServiceGetEndpointsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := core.NewServiceGetEndpointsLogic(r.Context(), svcCtx)
		resp, err := l.ServiceGetEndpoints(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
