...
// 服务级别 Ingress 获取
func ApplicationIngressGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetAppIngressRequest
		...
		l := core.NewApplicationIngressGetLogic(r.Context(), svcCtx)
		resp, err := l.ApplicationIngressGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
