...
func ClusterRoleDescribeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewClusterRoleDescribeLogic(r.Context(), svcCtx)
		resp, err := l.ClusterRoleDescribe(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
