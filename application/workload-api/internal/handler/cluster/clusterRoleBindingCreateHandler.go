...
func ClusterRoleBindingCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ClusterResourceYamlRequest
		...
		l := cluster.NewClusterRoleBindingCreateLogic(r.Context(), svcCtx)
		resp, err := l.ClusterRoleBindingCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
