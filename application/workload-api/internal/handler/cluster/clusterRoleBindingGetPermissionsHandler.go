...
func ClusterRoleBindingGetPermissionsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewClusterRoleBindingGetPermissionsLogic(r.Context(), svcCtx)
		resp, err := l.ClusterRoleBindingGetPermissions(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
