...
// 移除主体
func ClusterRoleBindingRemoveSubjectHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RemoveSubjectRequest
		...
		l := cluster.NewClusterRoleBindingRemoveSubjectLogic(r.Context(), svcCtx)
		resp, err := l.ClusterRoleBindingRemoveSubject(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
