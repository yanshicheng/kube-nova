...
func ClusterRoleBindingGetYamlHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewClusterRoleBindingGetYamlLogic(r.Context(), svcCtx)
		resp, err := l.ClusterRoleBindingGetYaml(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
