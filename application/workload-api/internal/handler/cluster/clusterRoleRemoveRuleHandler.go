...
// 移除 ClusterRole 规则
func ClusterRoleRemoveRuleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RemoveClusterRoleRuleRequest
		...
		l := cluster.NewClusterRoleRemoveRuleLogic(r.Context(), svcCtx)
		resp, err := l.ClusterRoleRemoveRule(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
