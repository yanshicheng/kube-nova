...
// 获取 ClusterRole 权限摘要
func ClusterRoleGetPermissionSummaryHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewClusterRoleGetPermissionSummaryLogic(r.Context(), svcCtx)
		resp, err := l.ClusterRoleGetPermissionSummary(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
