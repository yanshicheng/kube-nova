...
func IngressClassGetUsageHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewIngressClassGetUsageLogic(r.Context(), svcCtx)
		resp, err := l.IngressClassGetUsage(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
