...
// 取消默认 IngressClass
func IngressClassUnsetDefaultHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.IngressClassActionRequest
		...
		l := cluster.NewIngressClassUnsetDefaultLogic(r.Context(), svcCtx)
		resp, err := l.IngressClassUnsetDefault(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
