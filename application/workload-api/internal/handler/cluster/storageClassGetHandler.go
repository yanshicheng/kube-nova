...
// 获取 StorageClass 详情
func StorageClassGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewStorageClassGetLogic(r.Context(), svcCtx)
		resp, err := l.StorageClassGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
