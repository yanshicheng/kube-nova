...
func StorageClassGetYamlHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewStorageClassGetYamlLogic(r.Context(), svcCtx)
		resp, err := l.StorageClassGetYaml(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
