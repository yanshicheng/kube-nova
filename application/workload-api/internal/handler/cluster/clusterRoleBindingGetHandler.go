...
func ClusterRoleBindingGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewClusterRoleBindingGetLogic(r.Context(), svcCtx)
		resp, err := l.ClusterRoleBindingGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
