...
func ClusterRoleBindingCanDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewClusterRoleBindingCanDeleteLogic(r.Context(), svcCtx)
		resp, err := l.ClusterRoleBindingCanDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
