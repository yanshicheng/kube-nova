...
// 更新 IngressClass
func IngressClassUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewIngressClassUpdateLogic(r.Context(), svcCtx)
		resp, err := l.IngressClassUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
