...
// 设置默认 IngressClass
func IngressClassSetDefaultHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SetDefaultIngressClassRequest
		...
		l := cluster.NewIngressClassSetDefaultLogic(r.Context(), svcCtx)
		resp, err := l.IngressClassSetDefault(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
