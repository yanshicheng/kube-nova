...
// 添加 ClusterRole 规则
func ClusterRoleAddRuleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddClusterRoleRuleRequest
		...
		l := cluster.NewClusterRoleAddRuleLogic(r.Context(), svcCtx)
		resp, err := l.ClusterRoleAddRule(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
