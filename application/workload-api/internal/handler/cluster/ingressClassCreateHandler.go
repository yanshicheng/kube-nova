...
// 创建 IngressClass
func IngressClassCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewIngressClassCreateLogic(r.Context(), svcCtx)
		resp, err := l.IngressClassCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
