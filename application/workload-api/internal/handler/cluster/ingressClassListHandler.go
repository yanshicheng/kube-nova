...
// 获取 IngressClass 列表
func IngressClassListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.IngressClassListRequest
		...
		l := cluster.NewIngressClassListLogic(r.Context(), svcCtx)
		resp, err := l.IngressClassList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
