...
// 获取 StorageClass 列表
func StorageClassListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewStorageClassListLogic(r.Context(), svcCtx)
		resp, err := l.StorageClassList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
