...
func IngressClassGetControllerStatusHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.IngressClassNameRequest
		...
		l := cluster.NewIngressClassGetControllerStatusLogic(r.Context(), svcCtx)
		resp, err := l.IngressClassGetControllerStatus(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
