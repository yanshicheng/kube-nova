...
func IngressClassDescribeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewIngressClassDescribeLogic(r.Context(), svcCtx)
		resp, err := l.IngressClassDescribe(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
