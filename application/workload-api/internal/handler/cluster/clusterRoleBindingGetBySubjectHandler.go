...
// 根据主体获取绑定列表
func ClusterRoleBindingGetBySubjectHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetBySubjectRequest
		...
		l := cluster.NewClusterRoleBindingGetBySubjectLogic(r.Context(), svcCtx)
		resp, err := l.ClusterRoleBindingGetBySubject(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
