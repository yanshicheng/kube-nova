...
// 验证角色引用是否有效
func ClusterRoleBindingValidateRoleRefHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewClusterRoleBindingValidateRoleRefLogic(r.Context(), svcCtx)
		resp, err := l.ClusterRoleBindingValidateRoleRef(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
