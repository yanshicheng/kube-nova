...
// 删除 IngressClass
func IngressClassDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.IngressClassDeleteRequest
		...
		l := cluster.NewIngressClassDeleteLogic(r.Context(), svcCtx)
		resp, err := l.IngressClassDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
