...
func ClusterRoleBindingListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ClusterResourceListRequest
		...
		l := cluster.NewClusterRoleBindingListLogic(r.Context(), svcCtx)
		resp, err := l.ClusterRoleBindingList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
