...
func ClusterRoleGetUsageHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewClusterRoleGetUsageLogic(r.Context(), svcCtx)
		resp, err := l.ClusterRoleGetUsage(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
