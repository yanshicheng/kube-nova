...
func ClusterRoleBindingGetByRoleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetByClusterRoleRequest
		...
		l := cluster.NewClusterRoleBindingGetByRoleLogic(r.Context(), svcCtx)
		resp, err := l.ClusterRoleBindingGetByRole(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
