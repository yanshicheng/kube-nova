...
// 获取 PV 列表
func PVListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PVListRequest
		...
		l := cluster.NewPVListLogic(r.Context(), svcCtx)
		resp, err := l.PVList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
