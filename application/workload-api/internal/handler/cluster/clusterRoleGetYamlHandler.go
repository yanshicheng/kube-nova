...
// 获取 ClusterRole YAML
func ClusterRoleGetYamlHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewClusterRoleGetYamlLogic(r.Context(), svcCtx)
		resp, err := l.ClusterRoleGetYaml(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
