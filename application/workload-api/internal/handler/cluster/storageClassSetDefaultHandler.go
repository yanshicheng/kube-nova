...
// 设置默认 StorageClass
func StorageClassSetDefaultHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SetDefaultStorageClassRequest
		...
		l := cluster.NewStorageClassSetDefaultLogic(r.Context(), svcCtx)
		resp, err := l.StorageClassSetDefault(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
