...
// 获取 IngressClass 详情
func IngressClassGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewIngressClassGetLogic(r.Context(), svcCtx)
		resp, err := l.IngressClassGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
