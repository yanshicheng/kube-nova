...
func GetPodContainersWithClusterNamespaceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetPodContainersWithClusterNamespaceRequest
		...
		l := workload.NewGetPodContainersWithClusterNamespaceLogic(r.Context(), svcCtx)
		resp, err := l.GetPodContainersWithClusterNamespace(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
