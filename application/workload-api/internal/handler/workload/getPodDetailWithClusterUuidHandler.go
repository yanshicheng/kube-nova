...
func GetPodDetailWithClusterUuidHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetPodDetailWithClusterUuidRequest
		...
		l := workload.NewGetPodDetailWithClusterUuidLogic(r.Context(), svcCtx)
		resp, err := l.GetPodDetailWithClusterUuid(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
