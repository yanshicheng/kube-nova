...
// 获取 CronJob 下次执行时间
func GetNextScheduleTimeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewGetNextScheduleTimeLogic(r.Context(), svcCtx)
		resp, err := l.GetNextScheduleTime(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
