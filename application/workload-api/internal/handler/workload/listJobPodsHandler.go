...
// 获取指定job pod列表
func ListJobPodsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetJobPodListRequest
		...
		l := workload.NewListJobPodsLogic(r.Context(), svcCtx)
		resp, err := l.ListJobPods(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
