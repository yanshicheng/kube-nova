...
// 查询 CronJob 调度配置
func GetCronJobScheduleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewGetCronJobScheduleLogic(r.Context(), svcCtx)
		resp, err := l.GetCronJobSchedule(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
