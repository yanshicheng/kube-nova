...
// 修改资源滚动更新策略
func UpdateUpdateStrategyHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewUpdateUpdateStrategyLogic(r.Context(), svcCtx)
		resp, err := l.UpdateUpdateStrategy(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
