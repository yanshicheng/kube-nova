...
// 查询资源滚动更新策略
func GetUpdateStrategyHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewGetUpdateStrategyLogic(r.Context(), svcCtx)
		resp, err := l.GetUpdateStrategy(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
