...
// 修改高级容器配置
func UpdateAdvancedConfigHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CommUpdateAdvancedConfigRequest
		...
		l := workload.NewUpdateAdvancedConfigLogic(r.Context(), svcCtx)
		resp, err := l.UpdateAdvancedConfig(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
