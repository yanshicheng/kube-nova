...
// 调整资源副本数
func ScaleResourceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ReplicasResourceRequest
		...
		l := workload.NewScaleResourceLogic(r.Context(), svcCtx)
		resp, err := l.ScaleResource(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
