...
func InjectEphemeralContainerWithClusterUuidHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InjectEphemeralContainerWithClusterUuidRequest
		...
		l := workload.NewInjectEphemeralContainerWithClusterUuidLogic(r.Context(), svcCtx)
		resp, err := l.InjectEphemeralContainerWithClusterUuid(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
