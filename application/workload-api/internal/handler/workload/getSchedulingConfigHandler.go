...
// 查询调度配置
func GetSchedulingConfigHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewGetSchedulingConfigLogic(r.Context(), svcCtx)
		resp, err := l.GetSchedulingConfig(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
