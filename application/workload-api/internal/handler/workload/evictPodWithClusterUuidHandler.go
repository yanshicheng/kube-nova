...
func EvictPodWithClusterUuidHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewEvictPodWithClusterUuidLogic(r.Context(), svcCtx)
		resp, err := l.EvictPodWithClusterUuid(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
