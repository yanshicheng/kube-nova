...
// 查询 Job 并行度配置
func GetJobParallelismHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewGetJobParallelismLogic(r.Context(), svcCtx)
		resp, err := l.GetJobParallelism(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
