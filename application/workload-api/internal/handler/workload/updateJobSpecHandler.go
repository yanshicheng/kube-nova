...
func UpdateJobSpecHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateJobSpecRequest
		...
		l := workload.NewUpdateJobSpecLogic(r.Context(), svcCtx)
		resp, err := l.UpdateJobSpec(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
