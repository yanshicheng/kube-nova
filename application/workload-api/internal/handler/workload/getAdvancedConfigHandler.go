...
// 查询高级容器配置
func GetAdvancedConfigHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewGetAdvancedConfigLogic(r.Context(), svcCtx)
		resp, err := l.GetAdvancedConfig(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
