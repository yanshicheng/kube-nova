...
func RollbackToConfigHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RollbackToConfigRequest
		...
		l := workload.NewRollbackToConfigLogic(r.Context(), svcCtx)
		resp, err := l.RollbackToConfig(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
