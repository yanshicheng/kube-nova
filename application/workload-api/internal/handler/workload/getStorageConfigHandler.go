...
// 查询存储配置
func GetStorageConfigHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewGetStorageConfigLogic(r.Context(), svcCtx)
		resp, err := l.GetStorageConfig(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
