...
// 重启资源
func RestartResourceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewRestartResourceLogic(r.Context(), svcCtx)
		resp, err := l.RestartResource(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
