...
// 获取资源的labels
func GetResourceLabelsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewGetResourceLabelsLogic(r.Context(), svcCtx)
		resp, err := l.GetResourceLabels(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
