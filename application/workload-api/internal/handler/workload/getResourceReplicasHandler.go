...
// 查询资源副本数
func GetResourceReplicasHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewGetResourceReplicasLogic(r.Context(), svcCtx)
		resp, err := l.GetResourceReplicas(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
