...
// 回滚到指定版本（Deployment）
func RollbackToRevisionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RollbackToRevisionRequest
		...
		l := workload.NewRollbackToRevisionLogic(r.Context(), svcCtx)
		resp, err := l.RollbackToRevision(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
