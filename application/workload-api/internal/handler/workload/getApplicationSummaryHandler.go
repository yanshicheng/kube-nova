...
// 获取应用摘要
func GetApplicationSummaryHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetApplicationSummaryRequest
		...
		l := workload.NewGetApplicationSummaryLogic(r.Context(), svcCtx)
		resp, err := l.GetApplicationSummary(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
