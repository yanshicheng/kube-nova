...
func GetWorkloadPodContainersHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetDefaultPodNameRequest
		...
		l := workload.NewGetWorkloadPodContainersLogic(r.Context(), svcCtx)
		resp, err := l.GetWorkloadPodContainers(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
