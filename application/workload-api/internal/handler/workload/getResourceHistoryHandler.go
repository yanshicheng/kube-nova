...
// 获取版本历史（Deployment）
func GetResourceHistoryHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewGetResourceHistoryLogic(r.Context(), svcCtx)
		resp, err := l.GetResourceHistory(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
