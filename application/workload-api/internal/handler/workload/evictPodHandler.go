...
// pod驱逐
func EvictPodHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DefaultPodNameRequest
		...
		l := workload.NewEvictPodLogic(r.Context(), svcCtx)
		resp, err := l.EvictPod(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
