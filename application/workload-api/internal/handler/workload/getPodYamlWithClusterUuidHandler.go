...
func GetPodYamlWithClusterUuidHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetPodYamlWithClusterUuidRequest
		...
		l := workload.NewGetPodYamlWithClusterUuidLogic(r.Context(), svcCtx)
		resp, err := l.GetPodYamlWithClusterUuid(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
