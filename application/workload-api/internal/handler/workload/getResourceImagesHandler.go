...
// 查询资源使用的镜像
func GetResourceImagesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewGetResourceImagesLogic(r.Context(), svcCtx)
		resp, err := l.GetResourceImages(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
