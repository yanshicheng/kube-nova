...
// 修改环境变量
func UpdateEnvVarsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateEnvVarsRequest
		...
		//	return
		//}
		l := workload.NewUpdateEnvVarsLogic(r.Context(), svcCtx)
		resp, err := l.UpdateEnvVars(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
