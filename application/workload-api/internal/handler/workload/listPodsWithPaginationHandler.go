...
// 获取Pod列表（带分页、过滤、排序）
func ListPodsWithPaginationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListPodsWithPaginationRequest
		...
		l := workload.NewListPodsWithPaginationLogic(r.Context(), svcCtx)
		resp, err := l.ListPodsWithPagination(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
