...
// 获取命名空间事件
func GetNamespaceEventsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewGetNamespaceEventsLogic(r.Context(), svcCtx)
		resp, err := l.GetNamespaceEvents(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
