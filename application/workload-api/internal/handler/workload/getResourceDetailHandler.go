...
// 获取资源详情信息
func GetResourceDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewGetResourceDetailLogic(r.Context(), svcCtx)
		resp, err := l.GetResourceDetail(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
