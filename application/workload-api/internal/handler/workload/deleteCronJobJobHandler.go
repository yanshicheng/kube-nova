...
func DeleteCronJobJobHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := workload.NewDeleteCronJobJobLogic(r.Context(), svcCtx)
		resp, err := l.DeleteCronJobJob(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
