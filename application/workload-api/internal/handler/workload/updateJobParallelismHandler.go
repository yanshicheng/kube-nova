...
// 修改 Job 并行度配置
func UpdateJobParallelismHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateJobParallelismRequest
		...
		l := workload.NewUpdateJobParallelismLogic(r.Context(), svcCtx)
		resp, err := l.UpdateJobParallelism(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
