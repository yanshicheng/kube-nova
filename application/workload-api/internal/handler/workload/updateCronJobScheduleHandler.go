...
// 修改 CronJob 调度配置
func UpdateCronJobScheduleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateCronJobScheduleRequest
		...
		l := workload.NewUpdateCronJobScheduleLogic(r.Context(), svcCtx)
		resp, err := l.UpdateCronJobSchedule(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
