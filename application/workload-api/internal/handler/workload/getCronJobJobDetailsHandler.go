...
// 查询 CronJob Job 详情
func GetCronJobJobDetailsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetDefaultJobNameRequest
		...
		l := workload.NewGetCronJobJobDetailsLogic(r.Context(), svcCtx)
		resp, err := l.GetCronJobJobDetails(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
