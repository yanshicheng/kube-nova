...
// 创建 HPA 资源
func HPACreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.HPARequest
		...
		l := autoscaling.NewHPACreateLogic(r.Context(), svcCtx)
		resp, err := l.HPACreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
