...
// 创建 VPA 资源
func VPACreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.VPARequest
		...
		l := autoscaling.NewVPACreateLogic(r.Context(), svcCtx)
		resp, err := l.VPACreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
