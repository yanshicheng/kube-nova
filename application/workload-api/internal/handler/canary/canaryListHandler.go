...
// 获取 Canary 列表
func CanaryListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CanaryListRequest
		...
		l := canary.NewCanaryListLogic(r.Context(), svcCtx)
		resp, err := l.CanaryList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
