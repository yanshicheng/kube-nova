...
// 查询应用列表
func ApplicationSearchHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchOnecProjectApplicationReq
		...
		l := application.NewApplicationSearchLogic(r.Context(), svcCtx)
		resp, err := l.ApplicationSearch(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
