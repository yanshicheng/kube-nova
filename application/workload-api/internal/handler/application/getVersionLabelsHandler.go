...
// 获取某一个版本的 labels
func GetVersionLabelsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := application.NewGetVersionLabelsLogic(r.Context(), svcCtx)
		resp, err := l.GetVersionLabels(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
