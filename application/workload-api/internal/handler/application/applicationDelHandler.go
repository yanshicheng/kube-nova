...
// 删除应用
func ApplicationDelHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := application.NewApplicationDelLogic(r.Context(), svcCtx)
		resp, err := l.ApplicationDel(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
