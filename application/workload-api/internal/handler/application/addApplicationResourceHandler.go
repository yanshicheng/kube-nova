...
// 添加应用资源
func AddApplicationResourceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddApplicationResource
		...
		l := application.NewAddApplicationResourceLogic(r.Context(), svcCtx)
		resp, err := l.AddApplicationResource(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
