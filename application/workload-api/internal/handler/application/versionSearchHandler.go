...
// 查询版本列表
func VersionSearchHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchOnecProjectVersionReq
		...
		l := application.NewVersionSearchLogic(r.Context(), svcCtx)
		resp, err := l.VersionSearch(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
