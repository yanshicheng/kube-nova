...
// 获取应用详情
func ApplicationDetailHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := application.NewApplicationDetailLogic(r.Context(), svcCtx)
		resp, err := l.ApplicationDetail(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
