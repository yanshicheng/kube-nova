...
// 批量导入 YAML 创建应用资源
func BatchCreateApplicationResourceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BatchCreateApplicationResource
		...
		l := application.NewBatchCreateApplicationResourceLogic(r.Context(), svcCtx)
		resp, err := l.BatchCreateApplicationResource(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
