...
// 更新应用
func ApplicationUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateOnecProjectApplicationReq
		...
		l := application.NewApplicationUpdateLogic(r.Context(), svcCtx)
		resp, err := l.ApplicationUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
