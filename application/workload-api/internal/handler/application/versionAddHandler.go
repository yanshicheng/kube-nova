...
// 添加版本
func VersionAddHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddOnecProjectVersionReq
		...
		l := application.NewVersionAddLogic(r.Context(), svcCtx)
		resp, err := l.VersionAdd(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
