...
func (l *UpdateReplicationPolicyLogic) UpdateReplicationPolicy(in *pb.UpdateReplicationPolicyReq) (*pb.UpdateReplicationPolicyResp, error) {
	...
	err = client.Replication().Update(in.PolicyId, policy)
	if err != nil {
		return nil, errorx.Msg("更新复制策略失败")
	}

	return &pb.UpdateReplicationPolicyResp{
		Message: "复制策略更新成功",
	}, nil
}
