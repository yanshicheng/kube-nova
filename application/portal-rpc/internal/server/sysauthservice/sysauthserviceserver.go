...
import (
	...
	"github.com/yanshicheng/kube-nova/application/portal-rpc/internal/logic/sysauthservice"
...
// api 鉴权
func (s *SysAuthServiceServer) ApiAuth(ctx context.Context, in *pb.ApiAuthRequest) (*pb.ApiAuthResponse, error) {
	l := sysauthservicelogic.NewApiAuthLogic(ctx, s.svcCtx)
	return l.ApiAuth(in)
}
