...
// 查询 Tekton 运行时资源
func DevopsTektonRuntimeResourceListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListTektonRuntimeResourceRequest
		...
		l := pipeline.NewDevopsTektonRuntimeResourceListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsTektonRuntimeResourceList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
