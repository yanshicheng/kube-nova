...
// 更新系统
func DevopsSystemUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsSystemRequest
		...
		l := pipeline.NewDevopsSystemUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsSystemUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
