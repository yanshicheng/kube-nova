...
// 查询流水线运行产物
func DevopsPipelineRunArtifactListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsPipelineRunArtifactRequest
		...
		l := pipeline.NewDevopsPipelineRunArtifactListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelineRunArtifactList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
