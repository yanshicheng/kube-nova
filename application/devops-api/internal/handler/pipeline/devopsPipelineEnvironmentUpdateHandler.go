...
// 更新流水线环境
func DevopsPipelineEnvironmentUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsPipelineEnvironmentRequest
		...
		l := pipeline.NewDevopsPipelineEnvironmentUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsPipelineEnvironmentUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
