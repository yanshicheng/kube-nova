...
// 预览流水线
func DevopsPipelinePreviewHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsPipelinePreviewLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelinePreview(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
