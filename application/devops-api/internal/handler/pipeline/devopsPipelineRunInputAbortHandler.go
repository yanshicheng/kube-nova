...
// 终止流水线人工确认
func DevopsPipelineRunInputAbortHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsPipelineRunInputAbortLogic(r.Context(), svcCtx)
		err := l.DevopsPipelineRunInputAbort(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
