...
// 删除 Jenkins 步骤
func DevopsJenkinsStepDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsJenkinsStepDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsJenkinsStepDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
