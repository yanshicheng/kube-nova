...
// 查询流水线阶段状态
func DevopsPipelineRunStageListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsPipelineRunStageRequest
		...
		l := pipeline.NewDevopsPipelineRunStageListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelineRunStageList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
