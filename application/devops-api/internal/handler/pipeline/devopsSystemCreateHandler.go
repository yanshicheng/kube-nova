...
// 创建系统
func DevopsSystemCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateDevopsSystemRequest
		...
		l := pipeline.NewDevopsSystemCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsSystemCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
