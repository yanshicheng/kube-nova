...
// 获取 Jenkins 步骤详情
func DevopsJenkinsStepGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsJenkinsStepGetLogic(r.Context(), svcCtx)
		resp, err := l.DevopsJenkinsStepGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
