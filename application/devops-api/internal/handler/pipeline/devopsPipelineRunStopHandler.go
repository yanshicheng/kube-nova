...
// 停止流水线执行
func DevopsPipelineRunStopHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsPipelineRunStopLogic(r.Context(), svcCtx)
		err := l.DevopsPipelineRunStop(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
