...
// 分页查询步骤分类
func DevopsStepCategoryListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsStepCategoryRequest
		...
		l := pipeline.NewDevopsStepCategoryListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsStepCategoryList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
