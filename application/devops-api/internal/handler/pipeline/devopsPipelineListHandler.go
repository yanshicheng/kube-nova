...
// 查询流水线
func DevopsPipelineListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsPipelineRequest
		...
		l := pipeline.NewDevopsPipelineListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelineList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
