...
// 更新 Jenkins 步骤状态
func DevopsJenkinsStepStatusHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsJenkinsStepStatusLogic(r.Context(), svcCtx)
		err := l.DevopsJenkinsStepStatus(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
