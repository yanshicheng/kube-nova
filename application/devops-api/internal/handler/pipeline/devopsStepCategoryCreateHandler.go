...
// 创建步骤分类
func DevopsStepCategoryCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateDevopsStepCategoryRequest
		...
		l := pipeline.NewDevopsStepCategoryCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsStepCategoryCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
