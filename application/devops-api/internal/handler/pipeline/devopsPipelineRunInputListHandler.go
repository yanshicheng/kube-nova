...
// 查询流水线人工确认
func DevopsPipelineRunInputListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsPipelineRunInputRequest
		...
		l := pipeline.NewDevopsPipelineRunInputListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelineRunInputList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
