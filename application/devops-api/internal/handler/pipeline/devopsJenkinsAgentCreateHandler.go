...
// 创建 Jenkins Agent
func DevopsJenkinsAgentCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateDevopsJenkinsAgentRequest
		...
		l := pipeline.NewDevopsJenkinsAgentCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsJenkinsAgentCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
