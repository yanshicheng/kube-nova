...
// 流水线驾驶舱
func DevopsPipelineDashboardHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DevopsPipelineDashboardRequest
		...
		l := pipeline.NewDevopsPipelineDashboardLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelineDashboard(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
