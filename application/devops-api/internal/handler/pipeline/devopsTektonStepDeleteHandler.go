...
// 删除 Tekton 步骤
func DevopsTektonStepDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsTektonStepDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsTektonStepDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
