...
// 预览 Jenkins Pipeline
func DevopsPipelineTemplatePreviewHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsPipelineTemplatePreviewLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelineTemplatePreview(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
