...
// 更新流水线模板状态
func DevopsPipelineTemplateStatusHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsPipelineTemplateStatusLogic(r.Context(), svcCtx)
		err := l.DevopsPipelineTemplateStatus(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
