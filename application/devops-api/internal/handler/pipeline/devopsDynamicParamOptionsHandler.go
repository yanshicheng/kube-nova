...
// 动态参数选项
func DevopsDynamicParamOptionsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DynamicParamOptionsRequest
		...
		l := pipeline.NewDevopsDynamicParamOptionsLogic(r.Context(), svcCtx)
		resp, err := l.DevopsDynamicParamOptions(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
