...
// 删除流水线环境
func DevopsPipelineEnvironmentDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsPipelineEnvironmentDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsPipelineEnvironmentDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
