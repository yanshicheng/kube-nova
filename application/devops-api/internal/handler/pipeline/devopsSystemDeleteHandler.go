...
// 删除系统
func DevopsSystemDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsSystemDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsSystemDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
