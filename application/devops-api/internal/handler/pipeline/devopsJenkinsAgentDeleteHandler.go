...
// 删除 Jenkins Agent
func DevopsJenkinsAgentDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsJenkinsAgentDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsJenkinsAgentDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
