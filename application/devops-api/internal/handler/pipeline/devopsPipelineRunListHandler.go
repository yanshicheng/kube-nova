...
// 查询流水线执行记录
func DevopsPipelineRunListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsPipelineRunRequest
		...
		l := pipeline.NewDevopsPipelineRunListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelineRunList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
