...
// 更新 Jenkins 步骤
func DevopsJenkinsStepUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsStepTemplateRequest
		...
		l := pipeline.NewDevopsJenkinsStepUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsJenkinsStepUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
