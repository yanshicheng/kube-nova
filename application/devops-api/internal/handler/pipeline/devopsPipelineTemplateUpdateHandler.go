...
// 更新流水线模板
func DevopsPipelineTemplateUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsPipelineTemplateRequest
		...
		l := pipeline.NewDevopsPipelineTemplateUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsPipelineTemplateUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
