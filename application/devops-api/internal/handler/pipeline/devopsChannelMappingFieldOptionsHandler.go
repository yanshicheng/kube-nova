...
// 渠道映射字段选项
func DevopsChannelMappingFieldOptionsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ChannelMappingFieldOptionsRequest
		...
		l := pipeline.NewDevopsChannelMappingFieldOptionsLogic(r.Context(), svcCtx)
		resp, err := l.DevopsChannelMappingFieldOptions(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
