...
// 更新步骤参数到渠道分组映射
func DevopsStepChannelParamMappingUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateStepChannelParamMappingRequest
		...
		l := logic.NewDevopsStepChannelParamMappingUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsStepChannelParamMappingUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
