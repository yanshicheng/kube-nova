...
// 保存流水线模板步骤编排
func DevopsPipelineTemplateStepsSaveHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SaveDevopsPipelineTemplateStepsRequest
		...
		l := pipeline.NewDevopsPipelineTemplateStepsSaveLogic(r.Context(), svcCtx)
		err := l.DevopsPipelineTemplateStepsSave(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
