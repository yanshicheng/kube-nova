...
// 查询流水线 YAML 快照
func DevopsPipelineRunYamlSnapshotHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DevopsPipelineRunYamlSnapshotRequest
		...
		l := pipeline.NewDevopsPipelineRunYamlSnapshotLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelineRunYamlSnapshot(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
