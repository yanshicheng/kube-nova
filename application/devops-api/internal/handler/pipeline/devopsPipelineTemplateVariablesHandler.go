...
// 查看流水线模板变量
func DevopsPipelineTemplateVariablesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsPipelineTemplateVariablesLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelineTemplateVariables(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
