...
// 更新流水线
func DevopsPipelineUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsPipelineRequest
		...
		l := pipeline.NewDevopsPipelineUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsPipelineUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
