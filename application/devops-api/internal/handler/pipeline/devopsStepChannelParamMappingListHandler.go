...
// 查询步骤参数到渠道分组映射
func DevopsStepChannelParamMappingListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.StepChannelParamMappingListRequest
		...
		l := pipeline.NewDevopsStepChannelParamMappingListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsStepChannelParamMappingList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
