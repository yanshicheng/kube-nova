...
// 更新 Tekton 步骤状态
func DevopsTektonStepStatusHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsTektonStepStatusLogic(r.Context(), svcCtx)
		err := l.DevopsTektonStepStatus(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
