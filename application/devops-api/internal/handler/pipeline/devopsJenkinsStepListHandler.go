...
// 分页查询 Jenkins 步骤
func DevopsJenkinsStepListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsStepTemplateRequest
		...
		l := pipeline.NewDevopsJenkinsStepListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsJenkinsStepList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
