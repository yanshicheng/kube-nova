...
// 运行流水线
func DevopsPipelineRunHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RunDevopsPipelineRequest
		...
		l := pipeline.NewDevopsPipelineRunLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelineRun(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
