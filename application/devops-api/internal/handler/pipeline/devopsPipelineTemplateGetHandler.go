...
// 获取流水线模板详情
func DevopsPipelineTemplateGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsPipelineTemplateGetLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelineTemplateGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
