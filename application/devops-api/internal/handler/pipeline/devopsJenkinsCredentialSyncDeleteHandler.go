...
// 删除 Jenkins 凭证副本
func DevopsJenkinsCredentialSyncDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteJenkinsCredentialSyncRequest
		...
		l := pipeline.NewDevopsJenkinsCredentialSyncDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsJenkinsCredentialSyncDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
