...
// 批量更新 Tekton 步骤镜像
func DevopsTektonStepImageBatchUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BatchUpdateTektonStepImageRequest
		...
		l := pipeline.NewDevopsTektonStepImageBatchUpdateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsTektonStepImageBatchUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
