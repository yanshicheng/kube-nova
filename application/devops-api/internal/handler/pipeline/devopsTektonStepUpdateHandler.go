...
// 更新 Tekton 步骤
func DevopsTektonStepUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsTektonStepUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsTektonStepUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
