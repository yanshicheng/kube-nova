...
// 查询 Tekton 步骤镜像
func DevopsTektonStepImageListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListTektonStepImageRequest
		...
		l := pipeline.NewDevopsTektonStepImageListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsTektonStepImageList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
