...
// 查询 Jenkins Agent
func DevopsJenkinsAgentListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsJenkinsAgentRequest
		...
		l := pipeline.NewDevopsJenkinsAgentListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsJenkinsAgentList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
