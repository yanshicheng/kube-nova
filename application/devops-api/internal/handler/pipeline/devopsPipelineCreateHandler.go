...
// 创建流水线
func DevopsPipelineCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SaveDevopsPipelineRequest
		...
		l := pipeline.NewDevopsPipelineCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelineCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
