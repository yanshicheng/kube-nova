...
// 查询 Jenkins 凭证同步记录
func DevopsJenkinsCredentialSyncListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListJenkinsCredentialSyncRequest
		...
		l := pipeline.NewDevopsJenkinsCredentialSyncListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsJenkinsCredentialSyncList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
