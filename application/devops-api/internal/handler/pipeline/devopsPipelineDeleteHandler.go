...
// 删除流水线
func DevopsPipelineDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsPipelineDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsPipelineDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
