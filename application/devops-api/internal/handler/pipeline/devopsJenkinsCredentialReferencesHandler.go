...
// 查询 Jenkins 凭证引用流水线
func DevopsJenkinsCredentialReferencesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.JenkinsCredentialReferenceRequest
		...
		l := pipeline.NewDevopsJenkinsCredentialReferencesLogic(r.Context(), svcCtx)
		resp, err := l.DevopsJenkinsCredentialReferences(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
