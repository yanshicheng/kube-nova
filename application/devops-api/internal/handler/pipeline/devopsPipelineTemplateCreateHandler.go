...
// 创建流水线模板
func DevopsPipelineTemplateCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateDevopsPipelineTemplateRequest
		...
		l := pipeline.NewDevopsPipelineTemplateCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelineTemplateCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
