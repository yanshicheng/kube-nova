...
// 删除步骤分类
func DevopsStepCategoryDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsStepCategoryDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsStepCategoryDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
