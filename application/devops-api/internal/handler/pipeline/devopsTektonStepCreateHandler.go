...
// 创建 Tekton 步骤
func DevopsTektonStepCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsTektonStepCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsTektonStepCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
