...
// 查询 Jenkins Agent
func DevopsPipelineJenkinsAgentListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.JenkinsAgentListRequest
		...
		l := pipeline.NewDevopsPipelineJenkinsAgentListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelineJenkinsAgentList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
