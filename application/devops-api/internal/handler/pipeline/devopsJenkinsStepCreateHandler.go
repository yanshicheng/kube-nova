...
// 创建 Jenkins 步骤
func DevopsJenkinsStepCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateDevopsStepTemplateRequest
		...
		l := pipeline.NewDevopsJenkinsStepCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsJenkinsStepCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
