...
// 删除流水线模板
func DevopsPipelineTemplateDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsPipelineTemplateDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsPipelineTemplateDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
