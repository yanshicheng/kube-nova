...
// 获取 Tekton 步骤详情
func DevopsTektonStepGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsTektonStepGetLogic(r.Context(), svcCtx)
		resp, err := l.DevopsTektonStepGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
