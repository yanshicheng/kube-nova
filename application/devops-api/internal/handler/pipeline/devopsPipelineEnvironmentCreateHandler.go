...
// 创建流水线环境
func DevopsPipelineEnvironmentCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateDevopsPipelineEnvironmentRequest
		...
		l := pipeline.NewDevopsPipelineEnvironmentCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelineEnvironmentCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
