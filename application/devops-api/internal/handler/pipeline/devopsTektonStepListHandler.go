...
// 分页查询 Tekton 步骤
func DevopsTektonStepListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsTektonStepListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsTektonStepList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
