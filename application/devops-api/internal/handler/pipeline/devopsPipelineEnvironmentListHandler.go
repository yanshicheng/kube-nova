...
// 查询流水线环境
func DevopsPipelineEnvironmentListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsPipelineEnvironmentRequest
		...
		l := pipeline.NewDevopsPipelineEnvironmentListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsPipelineEnvironmentList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
