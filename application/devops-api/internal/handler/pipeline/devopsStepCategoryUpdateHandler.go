...
// 更新步骤分类
func DevopsStepCategoryUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsStepCategoryRequest
		...
		l := pipeline.NewDevopsStepCategoryUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsStepCategoryUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
