...
// 继续流水线人工确认
func DevopsPipelineRunInputProceedHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DevopsPipelineRunInputActionRequest
		...
		l := pipeline.NewDevopsPipelineRunInputProceedLogic(r.Context(), svcCtx)
		err := l.DevopsPipelineRunInputProceed(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
