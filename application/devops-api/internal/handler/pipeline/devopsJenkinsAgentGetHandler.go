...
// Jenkins Agent 详情
func DevopsJenkinsAgentGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := pipeline.NewDevopsJenkinsAgentGetLogic(r.Context(), svcCtx)
		resp, err := l.DevopsJenkinsAgentGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
