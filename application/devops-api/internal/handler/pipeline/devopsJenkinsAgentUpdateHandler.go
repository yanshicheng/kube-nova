...
// 更新 Jenkins Agent
func DevopsJenkinsAgentUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsJenkinsAgentRequest
		...
		l := pipeline.NewDevopsJenkinsAgentUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsJenkinsAgentUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
