...
// 查询系统
func DevopsSystemListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsSystemRequest
		...
		l := pipeline.NewDevopsSystemListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsSystemList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
