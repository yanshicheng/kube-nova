...
// 流水线运行质量汇总
func QualityRunSummaryHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.QualityRunSummaryRequest
		...
		l := quality.NewQualityRunSummaryLogic(r.Context(), svcCtx)
		resp, err := l.QualityRunSummary(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
