...
// 完成扫描报告上报
func QualityScanReportCompleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CompleteQualityScanReportRequest
		...
		l := quality.NewQualityScanReportCompleteLogic(r.Context(), svcCtx)
		resp, err := l.QualityScanReportComplete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
