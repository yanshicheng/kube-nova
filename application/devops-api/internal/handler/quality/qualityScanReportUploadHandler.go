...
// 上传扫描报告
func QualityScanReportUploadHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UploadQualityScanReportRequest
		...
		l := quality.NewQualityScanReportUploadLogic(r.Context(), svcCtx, r)
		resp, err := l.QualityScanReportUpload(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
