...
// 创建扫描计划快照
func QualityScanPlanSnapshotCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateQualityScanPlanSnapshotRequest
		...
		l := quality.NewQualityScanPlanSnapshotCreateLogic(r.Context(), svcCtx)
		resp, err := l.QualityScanPlanSnapshotCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
