...
// 查询报告上传批次明细
func QualityReportUploadEntryListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListQualityReportUploadEntryRequest
		...
		l := quality.NewQualityReportUploadEntryListLogic(r.Context(), svcCtx)
		resp, err := l.QualityReportUploadEntryList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
