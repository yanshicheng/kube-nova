...
// 查询报告上传批次
func QualityReportUploadBatchListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListQualityReportUploadBatchRequest
		...
		l := quality.NewQualityReportUploadBatchListLogic(r.Context(), svcCtx)
		resp, err := l.QualityReportUploadBatchList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
