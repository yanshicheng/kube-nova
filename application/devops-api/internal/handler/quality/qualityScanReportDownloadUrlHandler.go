...
// 扫描报告下载地址
func QualityScanReportDownloadUrlHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := quality.NewQualityScanReportDownloadUrlLogic(r.Context(), svcCtx)
		resp, err := l.QualityScanReportDownloadUrl(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
