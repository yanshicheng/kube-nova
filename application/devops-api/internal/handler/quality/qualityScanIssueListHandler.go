...
// 查询扫描问题
func QualityScanIssueListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListQualityScanIssueRequest
		...
		l := quality.NewQualityScanIssueListLogic(r.Context(), svcCtx)
		resp, err := l.QualityScanIssueList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
