...
// 报告上传明细下载
func QualityReportUploadEntryDownloadHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := quality.NewQualityReportUploadEntryDownloadLogic(r.Context(), svcCtx)
		resp, err := l.Open(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
