...
// 获取扫描计划快照
func QualityScanPlanSnapshotGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.QualityScanPlanSnapshotRequest
		...
		l := quality.NewQualityScanPlanSnapshotGetLogic(r.Context(), svcCtx)
		resp, err := l.QualityScanPlanSnapshotGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
