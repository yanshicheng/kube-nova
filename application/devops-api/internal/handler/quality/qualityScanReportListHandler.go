...
// 查询扫描报告
func QualityScanReportListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListQualityScanReportRequest
		...
		l := quality.NewQualityScanReportListLogic(r.Context(), svcCtx)
		resp, err := l.QualityScanReportList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
