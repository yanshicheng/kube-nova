...
// 扫描门禁评估
func QualityGateEvaluateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.QualityGateEvaluateRequest
		...
		l := quality.NewQualityGateEvaluateLogic(r.Context(), svcCtx)
		resp, err := l.QualityGateEvaluate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
