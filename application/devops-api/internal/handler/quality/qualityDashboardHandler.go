...
// 质量看板
func QualityDashboardHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.QualityDashboardRequest
		...
		l := quality.NewQualityDashboardLogic(r.Context(), svcCtx)
		resp, err := l.QualityDashboard(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
