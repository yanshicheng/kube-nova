...
// 扫描报告详情
func QualityScanReportGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := quality.NewQualityScanReportGetLogic(r.Context(), svcCtx)
		resp, err := l.QualityScanReportGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
