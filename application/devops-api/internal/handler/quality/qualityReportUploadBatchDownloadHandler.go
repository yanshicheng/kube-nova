...
// 报告上传批次原件下载
func QualityReportUploadBatchDownloadHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := quality.NewQualityReportUploadBatchDownloadLogic(r.Context(), svcCtx)
		resp, err := l.Open(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
