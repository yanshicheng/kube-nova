...
// 报告上传明细预览
func QualityReportUploadEntryPreviewHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := quality.NewQualityReportUploadEntryPreviewLogic(r.Context(), svcCtx)
		resp, err := l.Open(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
			writeReportObjectStream(w, resp, "inline")
		}
	}
}
