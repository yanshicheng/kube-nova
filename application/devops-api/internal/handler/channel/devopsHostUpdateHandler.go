...
// 更新主机资产
func DevopsHostUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsHostRequest
		...
		l := channel.NewDevopsHostUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsHostUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
