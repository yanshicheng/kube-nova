...
// 创建凭据
func DevopsCredentialCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateDevopsCredentialRequest
		...
		l := channel.NewDevopsCredentialCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsCredentialCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
