...
// 分页查询渠道
func DevopsChannelListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsChannelRequest
		...
		l := channel.NewDevopsChannelListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsChannelList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
