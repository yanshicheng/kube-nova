...
// 更新凭据
func DevopsCredentialUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsCredentialRequest
		...
		l := channel.NewDevopsCredentialUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsCredentialUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
