...
// 创建渠道类型
func DevopsChannelTypeCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateDevopsChannelTypeRequest
		...
		l := channel.NewDevopsChannelTypeCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsChannelTypeCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
