...
// 删除凭据
func DevopsCredentialDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := channel.NewDevopsCredentialDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsCredentialDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
