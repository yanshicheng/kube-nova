...
// 获取渠道分组详情
func DevopsChannelGroupGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := channel.NewDevopsChannelGroupGetLogic(r.Context(), svcCtx)
		resp, err := l.DevopsChannelGroupGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
