...
// 同步 Tekton 步骤到渠道实例
func DevopsChannelTektonStepSyncHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := channel.NewDevopsChannelTektonStepSyncLogic(r.Context(), svcCtx)
		err := l.DevopsChannelTektonStepSync(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
