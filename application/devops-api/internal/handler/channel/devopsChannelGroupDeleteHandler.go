...
// 删除渠道分组
func DevopsChannelGroupDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := channel.NewDevopsChannelGroupDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsChannelGroupDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
