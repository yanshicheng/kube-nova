...
// 创建主机资产
func DevopsHostCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateDevopsHostRequest
		...
		l := channel.NewDevopsHostCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsHostCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
