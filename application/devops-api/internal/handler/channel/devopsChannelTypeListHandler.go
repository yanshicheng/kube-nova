...
// 分页查询渠道类型
func DevopsChannelTypeListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsChannelTypeRequest
		...
		l := channel.NewDevopsChannelTypeListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsChannelTypeList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
