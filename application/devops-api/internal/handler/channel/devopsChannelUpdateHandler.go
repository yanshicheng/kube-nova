...
// 更新渠道
func DevopsChannelUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsChannelRequest
		...
		l := channel.NewDevopsChannelUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsChannelUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
