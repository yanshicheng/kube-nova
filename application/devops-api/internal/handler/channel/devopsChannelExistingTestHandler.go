...
// 测试已有渠道连通性
func DevopsChannelExistingTestHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := channel.NewDevopsChannelExistingTestLogic(r.Context(), svcCtx)
		resp, err := l.DevopsChannelExistingTest(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
