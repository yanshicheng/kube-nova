...
// 分页查询凭据
func DevopsCredentialListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsCredentialRequest
		...
		l := channel.NewDevopsCredentialListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsCredentialList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
