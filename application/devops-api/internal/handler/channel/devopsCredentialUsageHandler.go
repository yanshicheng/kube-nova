...
// 查询凭据使用资源
func DevopsCredentialUsageHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := channel.NewDevopsCredentialUsageLogic(r.Context(), svcCtx)
		resp, err := l.DevopsCredentialUsage(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
