...
// 更新渠道类型
func DevopsChannelTypeUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsChannelTypeRequest
		...
		l := channel.NewDevopsChannelTypeUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsChannelTypeUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
