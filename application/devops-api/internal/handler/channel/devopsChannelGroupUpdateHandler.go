...
// 更新渠道分组
func DevopsChannelGroupUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsChannelGroupRequest
		...
		l := channel.NewDevopsChannelGroupUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsChannelGroupUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
