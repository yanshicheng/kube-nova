...
// 分页查询渠道分组
func DevopsChannelGroupListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsChannelGroupRequest
		...
		l := channel.NewDevopsChannelGroupListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsChannelGroupList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
