...
// 创建渠道
func DevopsChannelCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateDevopsChannelRequest
		...
		l := channel.NewDevopsChannelCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsChannelCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
