...
// 测试渠道配置连通性
func DevopsChannelTestHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TestDevopsChannelRequest
		...
		l := channel.NewDevopsChannelTestLogic(r.Context(), svcCtx)
		resp, err := l.DevopsChannelTest(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
