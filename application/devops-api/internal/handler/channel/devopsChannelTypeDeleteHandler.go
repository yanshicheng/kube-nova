...
// 删除渠道类型
func DevopsChannelTypeDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := channel.NewDevopsChannelTypeDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsChannelTypeDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
