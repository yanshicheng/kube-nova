...
// 分页查询主机资产
func DevopsHostListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsHostRequest
		...
		l := channel.NewDevopsHostListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsHostList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
