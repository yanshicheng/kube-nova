...
// 获取凭据详情
func DevopsCredentialGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := channel.NewDevopsCredentialGetLogic(r.Context(), svcCtx)
		resp, err := l.DevopsCredentialGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
