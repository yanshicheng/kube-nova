...
// 创建渠道分组
func DevopsChannelGroupCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateDevopsChannelGroupRequest
		...
		l := channel.NewDevopsChannelGroupCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsChannelGroupCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
