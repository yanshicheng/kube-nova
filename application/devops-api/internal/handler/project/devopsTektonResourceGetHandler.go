...
// 获取项目 Tekton 资源
func DevopsTektonResourceGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := project.NewDevopsTektonResourceGetLogic(r.Context(), svcCtx)
		resp, err := l.DevopsTektonResourceGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
