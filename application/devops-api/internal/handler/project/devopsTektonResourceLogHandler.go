...
func DevopsTektonResourceLogHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LogDevopsTektonResourceRequest
		...
		l := project.NewDevopsTektonResourceLogLogic(r.Context(), svcCtx)
		resp, err := l.DevopsTektonResourceLog(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
