...
// 分页查询配置中心项目配置
func DevopsProjectConfigListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsProjectConfigRequest
		...
		l := project.NewDevopsProjectConfigListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsProjectConfigList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
