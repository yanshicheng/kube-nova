...
// 创建项目 Tekton Secret
func DevopsTektonSecretCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SaveDevopsTektonSecretRequest
		...
		l := project.NewDevopsTektonSecretCreateLogic(r.Context(), svcCtx)
		err := l.DevopsTektonSecretCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
