...
// 新增项目渠道绑定
func DevopsProjectChannelAddHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddDevopsProjectChannelRequest
		...
		l := project.NewDevopsProjectChannelAddLogic(r.Context(), svcCtx)
		err := l.DevopsProjectChannelAdd(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
