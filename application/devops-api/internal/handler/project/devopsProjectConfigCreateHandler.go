...
// 创建配置中心项目配置
func DevopsProjectConfigCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateDevopsProjectConfigRequest
		...
		l := project.NewDevopsProjectConfigCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsProjectConfigCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
