...
func DevopsTektonSecretBindingListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsTektonSecretBindingRequest
		...
		l := project.NewDevopsTektonSecretBindingListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsTektonSecretBindingList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
