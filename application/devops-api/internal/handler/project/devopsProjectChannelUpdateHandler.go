...
// 更新项目渠道绑定
func DevopsProjectChannelUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsProjectChannelBindingRequest
		...
		l := project.NewDevopsProjectChannelUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsProjectChannelUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
