...
// 获取配置中心项目配置
func DevopsProjectConfigGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := project.NewDevopsProjectConfigGetLogic(r.Context(), svcCtx)
		resp, err := l.DevopsProjectConfigGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
