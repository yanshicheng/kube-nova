...
// 更新配置中心项目配置
func DevopsProjectConfigUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsProjectConfigRequest
		...
		l := project.NewDevopsProjectConfigUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsProjectConfigUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
