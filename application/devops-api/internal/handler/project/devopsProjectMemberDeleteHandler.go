...
// 删除项目成员
func DevopsProjectMemberDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := project.NewDevopsProjectMemberDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsProjectMemberDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
