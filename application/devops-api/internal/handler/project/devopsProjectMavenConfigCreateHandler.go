...
// 创建项目 Maven 配置
func DevopsProjectMavenConfigCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateDevopsProjectMavenConfigRequest
		...
		l := project.NewDevopsProjectMavenConfigCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsProjectMavenConfigCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
