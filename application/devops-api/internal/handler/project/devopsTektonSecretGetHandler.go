...
// 获取项目 Tekton Secret
func DevopsTektonSecretGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetDevopsTektonSecretRequest
		...
		l := project.NewDevopsTektonSecretGetLogic(r.Context(), svcCtx)
		resp, err := l.DevopsTektonSecretGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
