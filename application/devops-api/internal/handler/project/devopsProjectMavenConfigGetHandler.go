...
// 获取项目 Maven 配置
func DevopsProjectMavenConfigGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := project.NewDevopsProjectMavenConfigGetLogic(r.Context(), svcCtx)
		resp, err := l.DevopsProjectMavenConfigGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
