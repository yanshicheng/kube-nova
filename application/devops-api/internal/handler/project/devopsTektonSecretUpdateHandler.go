...
// 更新项目 Tekton Secret
func DevopsTektonSecretUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsTektonSecretRequest
		...
		l := project.NewDevopsTektonSecretUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsTektonSecretUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
