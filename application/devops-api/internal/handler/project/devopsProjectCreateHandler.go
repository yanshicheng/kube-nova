...
// 创建 DevOps 项目
func DevopsProjectCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateDevopsProjectRequest
		...
		l := project.NewDevopsProjectCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsProjectCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
