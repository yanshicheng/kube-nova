...
// 查询项目 Tekton PVC
func DevopsTektonPVCListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsTektonPVCRequest
		...
		l := project.NewDevopsTektonPVCListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsTektonPVCList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
