...
// 查询配置中心类型树
func DevopsConfigTypeTreeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DevopsConfigTypeTreeRequest
		...
		l := project.NewDevopsConfigTypeTreeLogic(r.Context(), svcCtx)
		resp, err := l.DevopsConfigTypeTree(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
