...
// 执行项目 Tekton 资源动作
func DevopsTektonResourceActionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ActionDevopsTektonResourceRequest
		...
		l := project.NewDevopsTektonResourceActionLogic(r.Context(), svcCtx)
		err := l.DevopsTektonResourceAction(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
