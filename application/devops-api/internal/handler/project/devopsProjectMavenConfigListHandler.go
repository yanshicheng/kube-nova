...
// 分页查询项目 Maven 配置
func DevopsProjectMavenConfigListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsProjectMavenConfigRequest
		...
		l := project.NewDevopsProjectMavenConfigListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsProjectMavenConfigList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
