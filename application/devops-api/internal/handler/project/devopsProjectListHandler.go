...
// 分页查询 DevOps 项目
func DevopsProjectListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsProjectRequest
		...
		l := project.NewDevopsProjectListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsProjectList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
