...
func DevopsTektonSecretSyncHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SyncDevopsTektonSecretRequest
		...
		l := project.NewDevopsTektonSecretSyncLogic(r.Context(), svcCtx)
		err := l.DevopsTektonSecretSync(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
