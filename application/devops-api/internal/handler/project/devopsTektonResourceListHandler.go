...
// 查询项目 Tekton 资源
func DevopsTektonResourceListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsTektonResourceRequest
		...
		l := project.NewDevopsTektonResourceListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsTektonResourceList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
