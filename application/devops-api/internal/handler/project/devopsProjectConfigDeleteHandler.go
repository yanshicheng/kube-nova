...
// 删除配置中心项目配置
func DevopsProjectConfigDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := project.NewDevopsProjectConfigDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsProjectConfigDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
