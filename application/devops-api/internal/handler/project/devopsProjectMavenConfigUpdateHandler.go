...
// 更新项目 Maven 配置
func DevopsProjectMavenConfigUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsProjectMavenConfigRequest
		...
		l := project.NewDevopsProjectMavenConfigUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsProjectMavenConfigUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
