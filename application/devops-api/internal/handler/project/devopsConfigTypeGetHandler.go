...
// 获取配置中心类型
func DevopsConfigTypeGetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := project.NewDevopsConfigTypeGetLogic(r.Context(), svcCtx)
		resp, err := l.DevopsConfigTypeGet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
