...
// 分页查询配置中心类型
func DevopsConfigTypeListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsConfigTypeRequest
		...
		l := project.NewDevopsConfigTypeListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsConfigTypeList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
