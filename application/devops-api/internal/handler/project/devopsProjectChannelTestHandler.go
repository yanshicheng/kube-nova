...
// 测试项目渠道绑定
func DevopsProjectChannelTestHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := project.NewDevopsProjectChannelTestLogic(r.Context(), svcCtx)
		resp, err := l.DevopsProjectChannelTest(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
