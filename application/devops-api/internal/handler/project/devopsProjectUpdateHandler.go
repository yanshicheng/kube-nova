...
// 更新 DevOps 项目
func DevopsProjectUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsProjectRequest
		...
		l := project.NewDevopsProjectUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsProjectUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
