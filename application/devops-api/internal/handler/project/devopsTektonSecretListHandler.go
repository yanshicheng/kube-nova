...
// 查询项目 Tekton Secret
func DevopsTektonSecretListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsTektonSecretRequest
		...
		l := project.NewDevopsTektonSecretListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsTektonSecretList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
