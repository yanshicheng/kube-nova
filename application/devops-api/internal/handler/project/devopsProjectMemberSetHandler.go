...
// 设置项目成员
func DevopsProjectMemberSetHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SetDevopsProjectMembersRequest
		...
		l := project.NewDevopsProjectMemberSetLogic(r.Context(), svcCtx)
		err := l.DevopsProjectMemberSet(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
