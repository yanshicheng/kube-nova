...
// 分页查询项目成员
func DevopsProjectMemberListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsProjectMemberRequest
		...
		l := project.NewDevopsProjectMemberListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsProjectMemberList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
