...
// 绑定项目构建渠道
func DevopsProjectChannelBindHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BindDevopsProjectChannelsRequest
		...
		l := project.NewDevopsProjectChannelBindLogic(r.Context(), svcCtx)
		err := l.DevopsProjectChannelBind(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
