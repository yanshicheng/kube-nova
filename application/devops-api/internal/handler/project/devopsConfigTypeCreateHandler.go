...
// 创建配置中心类型
func DevopsConfigTypeCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateDevopsConfigTypeRequest
		...
		l := project.NewDevopsConfigTypeCreateLogic(r.Context(), svcCtx)
		resp, err := l.DevopsConfigTypeCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
