...
// 删除项目 Maven 配置
func DevopsProjectMavenConfigDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := project.NewDevopsProjectMavenConfigDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsProjectMavenConfigDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
