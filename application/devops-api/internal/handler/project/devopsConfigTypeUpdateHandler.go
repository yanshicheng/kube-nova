...
// 更新配置中心类型
func DevopsConfigTypeUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateDevopsConfigTypeRequest
		...
		l := project.NewDevopsConfigTypeUpdateLogic(r.Context(), svcCtx)
		err := l.DevopsConfigTypeUpdate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
