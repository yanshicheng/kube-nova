...
// 删除 DevOps 项目
func DevopsProjectDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := project.NewDevopsProjectDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsProjectDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
