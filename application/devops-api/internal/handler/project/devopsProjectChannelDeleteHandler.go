...
// 删除项目渠道绑定
func DevopsProjectChannelDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := project.NewDevopsProjectChannelDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsProjectChannelDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
