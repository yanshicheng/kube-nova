...
// 分页查询项目渠道绑定
func DevopsProjectChannelListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListDevopsProjectChannelBindingRequest
		...
		l := project.NewDevopsProjectChannelListLogic(r.Context(), svcCtx)
		resp, err := l.DevopsProjectChannelList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
