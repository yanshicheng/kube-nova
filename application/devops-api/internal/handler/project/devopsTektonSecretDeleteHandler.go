...
// 删除项目 Tekton Secret
func DevopsTektonSecretDeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteDevopsTektonSecretRequest
		...
		l := project.NewDevopsTektonSecretDeleteLogic(r.Context(), svcCtx)
		err := l.DevopsTektonSecretDelete(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
