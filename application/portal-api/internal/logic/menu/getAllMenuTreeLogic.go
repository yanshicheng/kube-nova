...
type GetAllMenuTreeLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewGetAllMenuTreeLogic(ctx context.Context, svcCtx *svc.ServiceContext) *GetAllMenuTreeLogic {
	return &GetAllMenuTreeLogic{
