...
func GetAlertGroupLevelChannelsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := alert.NewGetAlertGroupLevelChannelsLogic(r.Context(), svcCtx)
		resp, err := l.GetAlertGroupLevelChannels(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
