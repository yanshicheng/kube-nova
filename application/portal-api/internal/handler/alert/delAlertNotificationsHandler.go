...
func DelAlertNotificationsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := alert.NewDelAlertNotificationsLogic(r.Context(), svcCtx)
		resp, err := l.DelAlertNotifications(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
