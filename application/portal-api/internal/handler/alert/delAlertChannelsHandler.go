...
func DelAlertChannelsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := alert.NewDelAlertChannelsLogic(r.Context(), svcCtx)
		resp, err := l.DelAlertChannels(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
