...
func GetAlertNotificationsByIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := alert.NewGetAlertNotificationsByIdLogic(r.Context(), svcCtx)
		resp, err := l.GetAlertNotificationsById(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
