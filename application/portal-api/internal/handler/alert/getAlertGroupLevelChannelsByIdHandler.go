...
func GetAlertGroupLevelChannelsByIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := alert.NewGetAlertGroupLevelChannelsByIdLogic(r.Context(), svcCtx)
		resp, err := l.GetAlertGroupLevelChannelsById(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
