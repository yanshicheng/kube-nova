...
func GetAlertGroupMembersByIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := alert.NewGetAlertGroupMembersByIdLogic(r.Context(), svcCtx)
		resp, err := l.GetAlertGroupMembersById(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
