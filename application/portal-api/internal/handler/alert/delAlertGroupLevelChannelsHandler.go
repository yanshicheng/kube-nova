...
func DelAlertGroupLevelChannelsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := alert.NewDelAlertGroupLevelChannelsLogic(r.Context(), svcCtx)
		resp, err := l.DelAlertGroupLevelChannels(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
