...
func GetAlertGroupsByIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := alert.NewGetAlertGroupsByIdLogic(r.Context(), svcCtx)
		resp, err := l.GetAlertGroupsById(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
