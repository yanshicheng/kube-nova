...
func TestLinkHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TestLinkRequest
		...
		l := alert.NewTestLinkLogic(r.Context(), svcCtx)
		resp, err := l.TestLink(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
