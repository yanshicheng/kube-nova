...
func GetAlertChannelsByIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := alert.NewGetAlertChannelsByIdLogic(r.Context(), svcCtx)
		resp, err := l.GetAlertChannelsById(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
