...
func UnbindUserPlatformHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UnbindUserPlatformRequest
		...
		l := platform.NewUnbindUserPlatformLogic(r.Context(), svcCtx)
		resp, err := l.UnbindUserPlatform(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
