...
func SetDefaultSysPlatformHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SetDefaultSysPlatformRequest
		...
		l := platform.NewSetDefaultSysPlatformLogic(r.Context(), svcCtx)
		resp, err := l.SetDefaultSysPlatform(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
