...
func GetSysPlatformByIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := platform.NewGetSysPlatformByIdLogic(r.Context(), svcCtx)
		resp, err := l.GetSysPlatformById(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
