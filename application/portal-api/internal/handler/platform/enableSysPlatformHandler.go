...
func EnableSysPlatformHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.EnableSysPlatformRequest
		...
		l := platform.NewEnableSysPlatformLogic(r.Context(), svcCtx)
		resp, err := l.EnableSysPlatform(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
