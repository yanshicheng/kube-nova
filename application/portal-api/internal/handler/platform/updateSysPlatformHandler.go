...
func UpdateSysPlatformHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateSysPlatformRequest
		...
		l := platform.NewUpdateSysPlatformLogic(r.Context(), svcCtx)
		resp, err := l.UpdateSysPlatform(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
