...
func GetPlatformUsersHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetPlatformUsersRequest
		...
		l := platform.NewGetPlatformUsersLogic(r.Context(), svcCtx)
		resp, err := l.GetPlatformUsers(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
