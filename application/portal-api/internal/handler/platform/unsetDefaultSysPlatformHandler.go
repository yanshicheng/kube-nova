...
func UnsetDefaultSysPlatformHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UnsetDefaultSysPlatformRequest
		...
		l := platform.NewUnsetDefaultSysPlatformLogic(r.Context(), svcCtx)
		resp, err := l.UnsetDefaultSysPlatform(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
