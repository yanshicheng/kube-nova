...
func DisableSysPlatformHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DisableSysPlatformRequest
		...
		l := platform.NewDisableSysPlatformLogic(r.Context(), svcCtx)
		resp, err := l.DisableSysPlatform(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
