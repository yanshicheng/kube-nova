...
func AddSysPlatformHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddSysPlatformRequest
		...
		l := platform.NewAddSysPlatformLogic(r.Context(), svcCtx)
		resp, err := l.AddSysPlatform(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
