...
// 解绑项目平台
func UnbindProjectPlatformHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UnbindProjectPlatformReq
		...
		l := project.NewUnbindProjectPlatformLogic(r.Context(), svcCtx)
		err := l.UnbindProjectPlatform(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
