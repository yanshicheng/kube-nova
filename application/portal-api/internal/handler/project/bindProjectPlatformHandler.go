...
// 绑定项目平台
func BindProjectPlatformHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BindProjectPlatformReq
		...
		l := project.NewBindProjectPlatformLogic(r.Context(), svcCtx)
		err := l.BindProjectPlatform(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
