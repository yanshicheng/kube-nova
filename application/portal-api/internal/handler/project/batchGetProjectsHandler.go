...
// 批量获取项目
func BatchGetProjectsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PortalBatchGetProjectReq
		...
		l := project.NewBatchGetProjectsLogic(r.Context(), svcCtx)
		resp, err := l.BatchGetProjects(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
