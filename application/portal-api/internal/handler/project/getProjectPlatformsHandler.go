...
// 获取项目平台
func GetProjectPlatformsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.PortalProjectMemberReq
		...
		l := project.NewGetProjectPlatformsLogic(r.Context(), svcCtx)
		resp, err := l.GetProjectPlatforms(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
