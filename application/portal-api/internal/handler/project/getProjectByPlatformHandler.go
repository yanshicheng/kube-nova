...
// 获取平台下项目
func GetProjectByPlatformHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetProjectByPlatformReq
		...
		l := project.NewGetProjectByPlatformLogic(r.Context(), svcCtx)
		resp, err := l.GetProjectByPlatform(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
