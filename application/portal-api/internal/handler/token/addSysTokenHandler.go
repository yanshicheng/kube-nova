...
func AddSysTokenHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddSysTokenRequest
		...
		l := token.NewAddSysTokenLogic(r.Context(), svcCtx)
		resp, err := l.AddSysToken(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
