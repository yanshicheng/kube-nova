...
func UpdateSysAPIHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateSysAPIRequest
		...
		l := api.NewUpdateSysAPILogic(r.Context(), svcCtx)
		resp, err := l.UpdateSysAPI(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
