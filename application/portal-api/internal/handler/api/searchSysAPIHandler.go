...
func SearchSysAPIHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchSysAPIRequest
		...
		l := api.NewSearchSysAPILogic(r.Context(), svcCtx)
		resp, err := l.SearchSysAPI(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
