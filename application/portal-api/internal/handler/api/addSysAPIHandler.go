...
func AddSysAPIHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddSysAPIRequest
		...
		l := api.NewAddSysAPILogic(r.Context(), svcCtx)
		resp, err := l.AddSysAPI(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
