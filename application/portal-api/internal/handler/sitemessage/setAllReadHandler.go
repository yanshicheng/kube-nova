...
func SetAllReadHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SetAllReadRequest
		...
		l := sitemessage.NewSetAllReadLogic(r.Context(), svcCtx)
		resp, err := l.SetAllRead(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
