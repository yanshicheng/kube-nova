...
func GetSiteMessagesByIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetSiteMessagesByIdRequest
		...
		l := sitemessage.NewGetSiteMessagesByIdLogic(r.Context(), svcCtx)
		resp, err := l.GetSiteMessagesById(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
