...
func DelSiteMessagesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DelSiteMessagesRequest
		...
		l := sitemessage.NewDelSiteMessagesLogic(r.Context(), svcCtx)
		resp, err := l.DelSiteMessages(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
