...
func BatchDelSiteMessagesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BatchDelSiteMessagesRequest
		...
		l := sitemessage.NewBatchDelSiteMessagesLogic(r.Context(), svcCtx)
		resp, err := l.BatchDelSiteMessages(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
