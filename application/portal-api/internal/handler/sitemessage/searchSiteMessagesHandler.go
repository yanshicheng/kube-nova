...
func SearchSiteMessagesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchSiteMessagesRequest
		...
		l := sitemessage.NewSearchSiteMessagesLogic(r.Context(), svcCtx)
		resp, err := l.SearchSiteMessages(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
