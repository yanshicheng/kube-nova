...
func BatchReadSiteMessagesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BatchReadSiteMessagesRequest
		...
		l := sitemessage.NewBatchReadSiteMessagesLogic(r.Context(), svcCtx)
		resp, err := l.BatchReadSiteMessages(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
