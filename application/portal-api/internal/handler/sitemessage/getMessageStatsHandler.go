...
func GetMessageStatsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetMessageStatsRequest
		...
		l := sitemessage.NewGetMessageStatsLogic(r.Context(), svcCtx)
		resp, err := l.GetMessageStats(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
