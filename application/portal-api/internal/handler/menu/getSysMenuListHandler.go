...
func GetSysMenuListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetSysMenuListRequest
		...
		l := menu.NewGetSysMenuListLogic(r.Context(), svcCtx)
		resp, err := l.GetSysMenuList(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
