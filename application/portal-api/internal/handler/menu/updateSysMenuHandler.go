...
func UpdateSysMenuHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateSysMenuRequest
		...
		l := menu.NewUpdateSysMenuLogic(r.Context(), svcCtx)
		resp, err := l.UpdateSysMenu(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
