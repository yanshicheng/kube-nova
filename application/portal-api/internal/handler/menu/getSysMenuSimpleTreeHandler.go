...
func GetSysMenuSimpleTreeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetSysMenuSimpleTreeRequest
		...
		l := menu.NewGetSysMenuSimpleTreeLogic(r.Context(), svcCtx)
		resp, err := l.GetSysMenuSimpleTree(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
