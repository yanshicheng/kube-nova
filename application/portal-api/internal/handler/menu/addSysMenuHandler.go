...
func AddSysMenuHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddSysMenuRequest
		...
		l := menu.NewAddSysMenuLogic(r.Context(), svcCtx)
		resp, err := l.AddSysMenu(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
