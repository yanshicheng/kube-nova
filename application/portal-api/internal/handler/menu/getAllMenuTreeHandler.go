...
func GetAllMenuTreeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetAllMenuTreeRequest
		...
		l := menu.NewGetAllMenuTreeLogic(r.Context(), svcCtx)
		resp, err := l.GetAllMenuTree(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
