...
func SearchSysMenuHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchSysMenuRequest
		...
		l := menu.NewSearchSysMenuLogic(r.Context(), svcCtx)
		resp, err := l.SearchSysMenu(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
