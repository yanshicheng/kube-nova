...
func SearchDeptByParentIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchDeptByParentIdRequest
		...
		l := dept.NewSearchDeptByParentIdLogic(r.Context(), svcCtx)
		resp, err := l.SearchDeptByParentId(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
