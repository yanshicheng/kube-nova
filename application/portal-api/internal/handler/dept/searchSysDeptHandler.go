...
func SearchSysDeptHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchSysDeptRequest
		...
		l := dept.NewSearchSysDeptLogic(r.Context(), svcCtx)
		resp, err := l.SearchSysDept(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
