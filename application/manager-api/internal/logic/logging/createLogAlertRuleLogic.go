...
type CreateLogAlertRuleLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewCreateLogAlertRuleLogic(ctx context.Context, svcCtx *svc.ServiceContext) *CreateLogAlertRuleLogic {
	return &CreateLogAlertRuleLogic{Logger: logx.WithContext(ctx), ctx: ctx, svcCtx: svcCtx}
}

func (l *CreateLogAlertRuleLogic) CreateLogAlertRule(req *types.CreateLogAlertRuleRequest) (resp *types.LogAlertRule, err error) {
	...
	rpcResp, err := l.svcCtx.LogRpc.AddLogAlertRule(l.ctx, &logservice.AddLogAlertRuleReq{
