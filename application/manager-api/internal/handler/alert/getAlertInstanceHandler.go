...
// 根据ID获取告警实例详细信息
func GetAlertInstanceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := alert.NewGetAlertInstanceLogic(r.Context(), svcCtx)
		resp, err := l.GetAlertInstance(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
