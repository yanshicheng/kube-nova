...
// 搜索告警实例列表，支持分页和条件筛选
func SearchAlertInstanceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchAlertInstanceRequest
		...
		l := alert.NewSearchAlertInstanceLogic(r.Context(), svcCtx)
		resp, err := l.SearchAlertInstance(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
