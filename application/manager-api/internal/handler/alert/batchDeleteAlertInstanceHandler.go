...
// 批量删除告警实例
func BatchDeleteAlertInstanceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BatchDeleteAlertInstanceRequest
		...
		l := alert.NewBatchDeleteAlertInstanceLogic(r.Context(), svcCtx)
		resp, err := l.BatchDeleteAlertInstance(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
