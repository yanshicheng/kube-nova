...
// 搜索告警规则分组列表
func SearchAlertRuleGroupHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchAlertRuleGroupRequest
		...
		l := alert.NewSearchAlertRuleGroupLogic(r.Context(), svcCtx)
		resp, err := l.SearchAlertRuleGroup(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
