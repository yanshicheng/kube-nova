...
// 删除告警实例
func DeleteAlertInstanceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := alert.NewDeleteAlertInstanceLogic(r.Context(), svcCtx)
		resp, err := l.DeleteAlertInstance(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
