...
// 导出分组下的告警规则为YAML
func BatchExportAlertRulesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BatchExportAlertRulesRequest
		...
		l := alert.NewBatchExportAlertRulesLogic(r.Context(), svcCtx)
		resp, err := l.BatchExportAlertRules(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
