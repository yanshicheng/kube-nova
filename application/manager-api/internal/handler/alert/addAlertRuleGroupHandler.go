...
// 创建新的告警规则分组
func AddAlertRuleGroupHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddAlertRuleGroupRequest
		...
		l := alert.NewAddAlertRuleGroupLogic(r.Context(), svcCtx)
		resp, err := l.AddAlertRuleGroup(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
