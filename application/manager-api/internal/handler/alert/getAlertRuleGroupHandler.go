...
// 根据ID获取告警规则分组详细信息
func GetAlertRuleGroupHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := alert.NewGetAlertRuleGroupLogic(r.Context(), svcCtx)
		resp, err := l.GetAlertRuleGroup(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
