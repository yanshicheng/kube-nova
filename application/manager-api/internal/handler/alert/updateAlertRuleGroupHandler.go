...
// 更新告警规则分组信息
func UpdateAlertRuleGroupHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateAlertRuleGroupRequest
		...
		l := alert.NewUpdateAlertRuleGroupLogic(r.Context(), svcCtx)
		resp, err := l.UpdateAlertRuleGroup(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
