...
// 将告警规则部署到指定集群的命名空间
func DeployAlertRulesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeployAlertRulesRequest
		...
		l := alert.NewDeployAlertRulesLogic(r.Context(), svcCtx)
		resp, err := l.DeployAlertRules(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
