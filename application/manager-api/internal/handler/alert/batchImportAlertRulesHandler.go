...
// 从YAML批量导入告警规则
func BatchImportAlertRulesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BatchImportAlertRulesRequest
		...
		l := alert.NewBatchImportAlertRulesLogic(r.Context(), svcCtx)
		resp, err := l.BatchImportAlertRules(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
