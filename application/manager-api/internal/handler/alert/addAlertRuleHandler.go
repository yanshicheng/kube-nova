...
// 创建新的告警规则
func AddAlertRuleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddAlertRuleRequest
		...
		l := alert.NewAddAlertRuleLogic(r.Context(), svcCtx)
		resp, err := l.AddAlertRule(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
