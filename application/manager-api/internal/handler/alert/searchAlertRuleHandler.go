...
// 搜索告警规则列表，支持分页和条件筛选
func SearchAlertRuleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchAlertRuleRequest
		...
		l := alert.NewSearchAlertRuleLogic(r.Context(), svcCtx)
		resp, err := l.SearchAlertRule(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
