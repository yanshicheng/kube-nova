...
// 删除日志告警事件
func DeleteLogAlertEventHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteLogAlertEventRequest
		...
		l := logging.NewDeleteLogAlertEventLogic(r.Context(), svcCtx)
		resp, err := l.DeleteLogAlertEvent(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
