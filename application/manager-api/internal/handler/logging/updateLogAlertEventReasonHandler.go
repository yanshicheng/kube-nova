...
// 补充日志告警事件原因
func UpdateLogAlertEventReasonHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateLogAlertEventReasonRequest
		...
		l := logging.NewUpdateLogAlertEventReasonLogic(r.Context(), svcCtx)
		resp, err := l.UpdateLogAlertEventReason(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
