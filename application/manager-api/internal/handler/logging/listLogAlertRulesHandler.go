...
// 查询日志告警列表
func ListLogAlertRulesHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListLogAlertRulesRequest
		...
		l := logging.NewListLogAlertRulesLogic(r.Context(), svcCtx)
		resp, err := l.ListLogAlertRules(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
