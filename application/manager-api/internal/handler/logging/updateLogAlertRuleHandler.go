...
// 更新日志告警
func UpdateLogAlertRuleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateLogAlertRuleRequest
		...
		l := logging.NewUpdateLogAlertRuleLogic(r.Context(), svcCtx)
		resp, err := l.UpdateLogAlertRule(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
