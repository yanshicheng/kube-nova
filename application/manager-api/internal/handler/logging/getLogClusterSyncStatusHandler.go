...
// 查询集群日志规则同步状态
func GetLogClusterSyncStatusHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LogClusterSyncStatusRequest
		...
		l := logging.NewGetLogClusterSyncStatusLogic(r.Context(), svcCtx)
		resp, err := l.GetLogClusterSyncStatus(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
