...
// 创建日志告警
func CreateLogAlertRuleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CreateLogAlertRuleRequest
		...
		l := logging.NewCreateLogAlertRuleLogic(r.Context(), svcCtx)
		resp, err := l.CreateLogAlertRule(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
