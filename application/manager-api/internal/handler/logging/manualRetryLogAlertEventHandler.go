...
// 手动补偿重试日志告警事件通知
func ManualRetryLogAlertEventHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ManualRetryLogAlertEventRequest
		...
		l := logging.NewManualRetryLogAlertEventLogic(r.Context(), svcCtx)
		resp, err := l.ManualRetryLogAlertEvent(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
