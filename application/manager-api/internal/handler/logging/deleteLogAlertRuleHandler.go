...
// 删除日志告警
func DeleteLogAlertRuleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteLogAlertRuleRequest
		...
		l := logging.NewDeleteLogAlertRuleLogic(r.Context(), svcCtx)
		resp, err := l.DeleteLogAlertRule(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
