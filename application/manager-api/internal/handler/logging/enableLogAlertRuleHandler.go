...
// 启用日志告警
func EnableLogAlertRuleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := logging.NewEnableLogAlertRuleLogic(r.Context(), svcCtx)
		resp, err := l.EnableLogAlertRule(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
