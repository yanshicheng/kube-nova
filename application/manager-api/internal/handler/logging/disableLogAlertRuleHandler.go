...
// 禁用日志告警
func DisableLogAlertRuleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ToggleLogAlertRuleRequest
		...
		l := logging.NewDisableLogAlertRuleLogic(r.Context(), svcCtx)
		resp, err := l.DisableLogAlertRule(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
