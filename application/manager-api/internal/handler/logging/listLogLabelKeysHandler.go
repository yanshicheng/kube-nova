...
func ListLogLabelKeysHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LogLabelKeysRequest
		...
		l := logging.NewListLogLabelKeysLogic(r.Context(), svcCtx)
		resp, err := l.ListLogLabelKeys(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
