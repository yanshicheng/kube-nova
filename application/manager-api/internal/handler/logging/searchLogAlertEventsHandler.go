...
// 查询日志告警事件
func SearchLogAlertEventsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchLogAlertEventsRequest
		...
		l := logging.NewSearchLogAlertEventsLogic(r.Context(), svcCtx)
		resp, err := l.SearchLogAlertEvents(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
