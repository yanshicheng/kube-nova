...
// 查询集群日志后端配置摘要
func GetLogClusterConfigHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LogClusterConfigRequest
		...
		l := logging.NewGetLogClusterConfigLogic(r.Context(), svcCtx)
		resp, err := l.GetLogClusterConfig(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
