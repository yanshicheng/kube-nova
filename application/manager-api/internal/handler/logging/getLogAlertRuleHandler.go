...
// 查询日志告警详情
func GetLogAlertRuleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetLogAlertRuleRequest
		...
		l := logging.NewGetLogAlertRuleLogic(r.Context(), svcCtx)
		resp, err := l.GetLogAlertRule(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
