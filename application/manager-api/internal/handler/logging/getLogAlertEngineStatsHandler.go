...
// 查询日志告警引擎统计面板
func GetLogAlertEngineStatsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LogAlertEngineStatsRequest
		...
		l := logging.NewGetLogAlertEngineStatsLogic(r.Context(), svcCtx)
		resp, err := l.GetLogAlertEngineStats(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
