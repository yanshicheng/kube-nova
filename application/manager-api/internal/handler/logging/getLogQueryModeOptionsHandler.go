...
func GetLogQueryModeOptionsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.LogQueryModeOptionsRequest
		...
		l := logging.NewGetLogQueryModeOptionsLogic(r.Context(), svcCtx)
		resp, err := l.GetLogQueryModeOptions(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
