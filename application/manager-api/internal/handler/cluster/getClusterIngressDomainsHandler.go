...
func GetClusterIngressDomainsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetClusterIngressDomainsRequest
		...
		l := cluster.NewGetClusterIngressDomainsLogic(r.Context(), svcCtx)
		resp, err := l.GetClusterIngressDomains(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
