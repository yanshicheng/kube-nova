...
func GetClusterResourceInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewGetClusterResourceInfoLogic(r.Context(), svcCtx)
		resp, err := l.GetClusterResourceInfo(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
