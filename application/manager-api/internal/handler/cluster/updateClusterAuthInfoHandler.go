...
func UpdateClusterAuthInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateClusterAuthInfoRequest
		...
		l := cluster.NewUpdateClusterAuthInfoLogic(r.Context(), svcCtx)
		resp, err := l.UpdateClusterAuthInfo(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
