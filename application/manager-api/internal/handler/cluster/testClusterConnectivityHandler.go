...
func TestClusterConnectivityHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TestClusterConnectivityRequest
		...
		l := cluster.NewTestClusterConnectivityLogic(r.Context(), svcCtx)
		resp, err := l.TestClusterConnectivity(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
