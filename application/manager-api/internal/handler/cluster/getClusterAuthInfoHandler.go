...
func GetClusterAuthInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewGetClusterAuthInfoLogic(r.Context(), svcCtx)
		resp, err := l.GetClusterAuthInfo(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
