...
func UpdateClusterAvatarHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ClusterUpdateAvatarRequest
		...
		l := cluster.NewUpdateClusterAvatarLogic(r.Context(), svcCtx)
		resp, err := l.UpdateClusterAvatar(r, &req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
