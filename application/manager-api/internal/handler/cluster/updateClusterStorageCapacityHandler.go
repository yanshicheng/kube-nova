...
func UpdateClusterStorageCapacityHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateClusterStorageCapacityRequest
		...
		l := cluster.NewUpdateClusterStorageCapacityLogic(r.Context(), svcCtx)
		resp, err := l.UpdateClusterStorageCapacity(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
