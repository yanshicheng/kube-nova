...
// 根据ID获取项目集群配额详细信息
func GetProjectClusterHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := project.NewGetProjectClusterLogic(r.Context(), svcCtx)
		resp, err := l.GetProjectCluster(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
