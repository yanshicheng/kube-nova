...
// 根据ID获取工作空间详细信息
func GetProjectWorkspaceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := project.NewGetProjectWorkspaceLogic(r.Context(), svcCtx)
		resp, err := l.GetProjectWorkspace(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
