...
func DeleteProjectWorkspaceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := project.NewDeleteProjectWorkspaceLogic(r.Context(), svcCtx)
		resp, err := l.DeleteProjectWorkspace(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
