...
func DeleteProjectClusterHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := project.NewDeleteProjectClusterLogic(r.Context(), svcCtx)
		resp, err := l.DeleteProjectCluster(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
