...
// 删除指定的审计日志记录
func DeleteProjectAuditLogHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteProjectAuditLogRequest
		...
		l := projectauditlog.NewDeleteProjectAuditLogLogic(r.Context(), svcCtx)
		resp, err := l.DeleteProjectAuditLog(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
