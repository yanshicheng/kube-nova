...
func DeleteProjectAuditLogBeforeDaysHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DeleteProjectAuditLogBeforeDaysRequest
		...
		l := projectauditlog.NewDeleteProjectAuditLogBeforeDaysLogic(r.Context(), svcCtx)
		resp, err := l.DeleteProjectAuditLogBeforeDays(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
