...
// 搜索审计日志列表，支持分页和多条件筛选
func SearchProjectAuditLogHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchProjectAuditLogRequest
		...
		l := projectauditlog.NewSearchProjectAuditLogLogic(r.Context(), svcCtx)
		resp, err := l.SearchProjectAuditLog(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
