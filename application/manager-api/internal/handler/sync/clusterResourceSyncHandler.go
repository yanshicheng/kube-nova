...
func ClusterResourceSyncHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SyncClusterResourceRequest
		...
		l := sync.NewClusterResourceSyncLogic(r.Context(), svcCtx)
		resp, err := l.ClusterResourceSync(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
