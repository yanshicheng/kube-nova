...
func ProjectOneClusterResourceHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := sync.NewProjectOneClusterResourceLogic(r.Context(), svcCtx)
		resp, err := l.ProjectOneClusterResource(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
