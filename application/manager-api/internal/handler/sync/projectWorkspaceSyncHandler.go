...
func ProjectWorkspaceSyncHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := sync.NewProjectWorkspaceSyncLogic(r.Context(), svcCtx)
		resp, err := l.ProjectWorkspaceSync(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
