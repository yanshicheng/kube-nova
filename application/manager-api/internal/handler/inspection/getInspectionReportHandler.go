...
// 查询巡检报告
func GetInspectionReportHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := inspection.NewGetInspectionReportLogic(r.Context(), svcCtx)
		resp, err := l.GetInspectionReport(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
