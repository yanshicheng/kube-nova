...
// 更新巡检项
func UpdateInspectionItemHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionItemUpdateRequest
		...
		l := inspection.NewUpdateInspectionItemLogic(r.Context(), svcCtx)
		resp, err := l.UpdateInspectionItem(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
