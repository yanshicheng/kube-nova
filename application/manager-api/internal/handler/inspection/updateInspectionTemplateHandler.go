...
// 更新巡检模板
func UpdateInspectionTemplateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionTemplateUpdateRequest
		...
		l := inspection.NewUpdateInspectionTemplateLogic(r.Context(), svcCtx)
		resp, err := l.UpdateInspectionTemplate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
