...
// 查询巡检数据大盘
func GetInspectionDashboardHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionDashboardRequest
		...
		l := inspection.NewGetInspectionDashboardLogic(r.Context(), svcCtx)
		resp, err := l.GetInspectionDashboard(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
