...
// 创建巡检任务
func AddInspectionTaskHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionTaskAddRequest
		...
		l := inspection.NewAddInspectionTaskLogic(r.Context(), svcCtx)
		resp, err := l.AddInspectionTask(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
