...
// 删除巡检模板
func DeleteInspectionTemplateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionTemplateDelRequest
		...
		l := inspection.NewDeleteInspectionTemplateLogic(r.Context(), svcCtx)
		resp, err := l.DeleteInspectionTemplate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
