...
// 创建巡检模板
func AddInspectionTemplateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionTemplateAddRequest
		...
		l := inspection.NewAddInspectionTemplateLogic(r.Context(), svcCtx)
		resp, err := l.AddInspectionTemplate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
