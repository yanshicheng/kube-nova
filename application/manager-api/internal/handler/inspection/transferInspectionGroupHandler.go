...
// 复制或迁移巡检分组
func TransferInspectionGroupHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionGroupTransferRequest
		...
		l := inspection.NewTransferInspectionGroupLogic(r.Context(), svcCtx)
		resp, err := l.TransferInspectionGroup(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
