...
// 手动结束运行中巡检记录
func FinishInspectionRecordHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionRecordFinishRequest
		...
		l := inspection.NewFinishInspectionRecordLogic(r.Context(), svcCtx)
		resp, err := l.FinishInspectionRecord(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
