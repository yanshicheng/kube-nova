...
// 删除巡检报告
func DeleteInspectionRecordHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionRecordDelRequest
		...
		l := inspection.NewDeleteInspectionRecordLogic(r.Context(), svcCtx)
		resp, err := l.DeleteInspectionRecord(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
