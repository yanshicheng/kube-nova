...
// 删除巡检任务
func DeleteInspectionTaskHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionTaskDelRequest
		...
		l := inspection.NewDeleteInspectionTaskLogic(r.Context(), svcCtx)
		resp, err := l.DeleteInspectionTask(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
