...
// 创建巡检分组
func AddInspectionGroupHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionGroupAddRequest
		...
		l := inspection.NewAddInspectionGroupLogic(r.Context(), svcCtx)
		resp, err := l.AddInspectionGroup(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
