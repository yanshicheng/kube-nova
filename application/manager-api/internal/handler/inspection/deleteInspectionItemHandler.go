...
// 删除巡检项
func DeleteInspectionItemHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionItemDelRequest
		...
		l := inspection.NewDeleteInspectionItemLogic(r.Context(), svcCtx)
		resp, err := l.DeleteInspectionItem(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
