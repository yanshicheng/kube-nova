...
// 导出巡检报告Excel
func ExportInspectionReportHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := inspection.NewExportInspectionReportLogic(r.Context(), svcCtx, w)
		err := l.ExportInspectionReport(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		}
	}
