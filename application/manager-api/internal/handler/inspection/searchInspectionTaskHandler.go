...
// 查询巡检任务
func SearchInspectionTaskHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionTaskSearchRequest
		...
		l := inspection.NewSearchInspectionTaskLogic(r.Context(), svcCtx)
		resp, err := l.SearchInspectionTask(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
