...
// 删除巡检分组
func DeleteInspectionGroupHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionGroupDelRequest
		...
		l := inspection.NewDeleteInspectionGroupLogic(r.Context(), svcCtx)
		resp, err := l.DeleteInspectionGroup(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
