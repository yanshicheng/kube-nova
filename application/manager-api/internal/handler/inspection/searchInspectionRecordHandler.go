...
// 查询巡检记录
func SearchInspectionRecordHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionRecordSearchRequest
		...
		l := inspection.NewSearchInspectionRecordLogic(r.Context(), svcCtx)
		resp, err := l.SearchInspectionRecord(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
