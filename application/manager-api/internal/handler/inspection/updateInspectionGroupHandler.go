...
// 更新巡检分组
func UpdateInspectionGroupHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionGroupUpdateRequest
		...
		l := inspection.NewUpdateInspectionGroupLogic(r.Context(), svcCtx)
		resp, err := l.UpdateInspectionGroup(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
