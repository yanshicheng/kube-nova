...
// 立即执行巡检
func RunInspectionTaskHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionTaskRunRequest
		...
		l := inspection.NewRunInspectionTaskLogic(r.Context(), svcCtx)
		resp, err := l.RunInspectionTask(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
