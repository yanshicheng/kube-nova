...
// 查询巡检模板
func SearchInspectionTemplateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionTemplateSearchRequest
		...
		l := inspection.NewSearchInspectionTemplateLogic(r.Context(), svcCtx)
		resp, err := l.SearchInspectionTemplate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
