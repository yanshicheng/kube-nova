...
// 查询巡检项
func SearchInspectionItemHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionItemSearchRequest
		...
		l := inspection.NewSearchInspectionItemLogic(r.Context(), svcCtx)
		resp, err := l.SearchInspectionItem(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
