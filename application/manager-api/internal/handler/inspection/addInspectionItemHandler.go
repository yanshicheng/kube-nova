...
// 创建巡检项
func AddInspectionItemHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionItemAddRequest
		...
		l := inspection.NewAddInspectionItemLogic(r.Context(), svcCtx)
		resp, err := l.AddInspectionItem(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
