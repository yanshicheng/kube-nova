...
// 查询巡检分组
func SearchInspectionGroupHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionGroupSearchRequest
		...
		l := inspection.NewSearchInspectionGroupLogic(r.Context(), svcCtx)
		resp, err := l.SearchInspectionGroup(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
