...
// 更新巡检任务
func UpdateInspectionTaskHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.InspectionTaskUpdateRequest
		...
		l := inspection.NewUpdateInspectionTaskLogic(r.Context(), svcCtx)
		resp, err := l.UpdateInspectionTask(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
