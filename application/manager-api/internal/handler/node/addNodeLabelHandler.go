...
func AddNodeLabelHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.NodeLabelRequest
		...
		l := node.NewAddNodeLabelLogic(r.Context(), svcCtx)
		resp, err := l.AddNodeLabel(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
