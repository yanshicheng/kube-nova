...
func AddNodeTaintHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.NodeTaintRequest
		...
		l := node.NewAddNodeTaintLogic(r.Context(), svcCtx)
		resp, err := l.AddNodeTaint(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
