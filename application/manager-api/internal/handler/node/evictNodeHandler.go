...
func EvictNodeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.NodeEvictRequest
		...
		l := node.NewEvictNodeLogic(r.Context(), svcCtx)
		resp, err := l.EvictNode(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
