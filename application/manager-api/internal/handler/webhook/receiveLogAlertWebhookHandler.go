...
// 接收日志告警
func ReceiveLogAlertWebhookHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := webhook.NewReceiveLogAlertWebhookLogic(r.Context(), svcCtx)
		resp, err := l.ReceiveLogAlertWebhook(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
